...
public class RedBasketPose {
    ...
    public final static Pose2d initialDrop = new Pose2d(-55.2, -54.75, Math.toRadians(45));
    ...
    public final static Pose2d submersible_park = new Pose2d(-22, -9, Math.toRadians(180));
