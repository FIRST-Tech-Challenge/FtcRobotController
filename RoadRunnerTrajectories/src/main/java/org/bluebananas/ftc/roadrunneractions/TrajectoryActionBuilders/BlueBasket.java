...
public class BlueBasket {
    ...
    public final static Pose2d pose_init = new Pose2d (47,59.5, Math.toRadians(-135));
    public final static Pose2d pose_drop = new Pose2d(56.5, 55.875, Math.toRadians(-135));
    ...
    public final static Pose2d pose_outer_sample = new Pose2d(60, 48.5, Math.toRadians(-73)); //outer closest to wall
