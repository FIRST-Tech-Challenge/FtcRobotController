...
public class BlueBasketPose {
    ...
    public final static Pose2d inner_sample = new Pose2d(50.5, 49, Math.toRadians(-93.5)); //inner closest to wall
    public final static Pose2d middle_sample = new Pose2d(56.5, 49.5, Math.toRadians(-85));
    public final static Pose2d outer_sample = new Pose2d(60, 48.5, Math.toRadians(-73)); //outer closest to wall
