...
import org.firstinspires.ftc.team6220_2021.Constants;
...
public class DriverInput {
    ...
    private final boolean[] buttonStates;  // One state for each button; there are 14 buttons available
    private final boolean[] lastButtonStates;
    private final double[] buttonHeldCounts;
    ...
    // Call at end of loop
    public void update() {
        System.arraycopy(buttonStates, 0, lastButtonStates, 0, 14);
