...
public class YellowDetector implements IObjectDetector<DuckPosition> {
    OpenCvWebcam webcam;
    ...
    @Override
    public DuckPosition objectDetected() {
    ...
    public static class DuckPipeline extends OpenCvPipeline {
        ...
        static final Point REGION2_TOPLEFT_ANCHOR_POINT = new Point(160, 60);
