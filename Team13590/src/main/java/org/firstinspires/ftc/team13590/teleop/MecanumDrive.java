...
import org.firstinspires.ftc.team13590.messages.MecanumCommandMessage;
import org.firstinspires.ftc.team13590.messages.MecanumLocalizerInputsMessage;
...
public final class MecanumDrive {
    public static class Params {
        ...
        public double kV = 0.0032; // 0.0032
        public double kA = 0.00122; // 0.00122
    ...
    public final DcMotorEx leftFrontDrive, leftBackDrive, rightBackDrive, rightFrontDrive;
    ...
    public class DriveLocalizer implements Localizer {
        ...
        public DriveLocalizer(Pose2d pose) {
            leftFrontEnc = new OverflowEncoder(new RawEncoder(MecanumDrive.this.leftFrontDrive));
            leftBackEnc = new OverflowEncoder(new RawEncoder(MecanumDrive.this.leftBackDrive));
            rightBackEnc = new OverflowEncoder(new RawEncoder(MecanumDrive.this.rightBackDrive));
            rightFrontEnc = new OverflowEncoder(new RawEncoder(MecanumDrive.this.rightFrontDrive));

            imu = lazyImu.get();

            // TODO: reverse encoders if needed
            //   leftFront.setDirection(DcMotorSimple.Direction.REVERSE);
            leftBackEnc.setDirection(DcMotor.Direction.REVERSE);
            leftFrontEnc.setDirection(DcMotor.Direction.REVERSE);
    ...
    public MecanumDrive(HardwareMap hardwareMap, Pose2d pose) {
        ...
        /*Two (dead) wheels - localizer = new TwoDeadWheelLocalizer(hardwareMap, lazyImu.get(), PARAMS.inPerTick, pose)
         assumes the forward-poiting econder to be named "par" and the perpendicular one to be named "perp".
         Three (dead) wheel - localizer = new ThreeDeadWheelLocalizer(hardwareMap, PARAMS.inPerTick, pose)
         assumes the two parellel encoders are named "par0", "par1", and "perp".
        */
