...
public class Constants {
    ...
    public static final int ROBOT_CAMERA_CENTER_X = 400;
    public static final int ROBOT_CAMERA_CENTER_Y = 300;
    public static final int GRABBER_CAMERA_CENTER_X = 400;
    public static final int GRABBER_CAMERA_CENTER_Y = 300;
}