...
public class TestAutonomous extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        Trajectory traject1 = drive.trajectoryBuilder(new Pose2d())
                .splineToConstantHeading(new Vector2d(X_POSITION_AWAY_FROM_WALL, 0), Math.toRadians(0))
                .splineToConstantHeading(new Vector2d(X_POSITION_AWAY_FROM_WALL, Y_POSITION_A), Math.toRadians(0))
                .splineToConstantHeading(new Vector2d(X_POSITION_1, Y_POSITION_A), Math.toRadians(0))
                .build();
