package com.acmerobotics.roadrunner.trajectorysequence;
...
import com.acmerobotics.roadrunner.trajectorysequence.sequencesegment.SequenceSegment;
import com.acmerobotics.roadrunner.trajectorysequence.sequencesegment.TrajectorySegment;
import com.acmerobotics.roadrunner.trajectorysequence.sequencesegment.TurnSegment;
import com.acmerobotics.roadrunner.trajectorysequence.sequencesegment.WaitSegment;
import com.acmerobotics.roadrunner.util.DashboardUtil;
...
public class TrajectorySequenceRunner {
    ...
    DriveSignal update(Pose2d poseEstimate, Pose2d poseVelocity) {
        ...
        if (currentTrajectorySequence != null) {
            ...
            if (currentSegment instanceof TrajectorySegment) {
                ...
                if (!follower.isFollowing()) {
                    packet.put("Trajectory Kind: ", "Straight Not Following");
                    currentSegmentIndex++;

                    driveSignal = new DriveSignal();
                } else {
                    packet.put("Trajectory Kind: ", "Straight");
                ...
                packet.put("Trajectory Kind: ", "Turn");
                ...
                packet.put("Trajectory Kind: ", "Wait");
        ...
        // if (driveSignal != null) {
            // packet.put("Drive Signal Velocity X: ", driveSignal.getVel().getX());
            // packet.put("Drive Signal Velocity Y: ", driveSignal.getVel().getY());
            // packet.put("Drive Signal Velocity Z: ", driveSignal.getVel().getHeading());
            // packet.put("Drive Signal Accel X: ", driveSignal.getAccel().getX());
            // packet.put("Drive Signal Accel Y: ", driveSignal.getAccel().getY());
            // packet.put("Drive Signal Accel Z: ", driveSignal.getAccel().getHeading());
        // }
