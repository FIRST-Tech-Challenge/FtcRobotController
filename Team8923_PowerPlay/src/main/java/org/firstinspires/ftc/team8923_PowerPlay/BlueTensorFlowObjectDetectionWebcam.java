...
@Autonomous(name = "BlueTensorFlowObjectDetectionWebcam ")
public class BlueTensorFlowObjectDetectionWebcam extends BaseOpMode {
     ...
     */
    private static final String TFOD_MODEL_ASSET = "8923BlueTensorFlowModel.tflite";
