...
@Autonomous(name = "Season: Freight Frenzy Autonomous Plan C _ NoOtherSide Inverted")
public class FreightFrenzyAutonomousPlanA_NoOtherSide_Inverted extends CommandOpMode {
...
//            RR.runSCORING();
        ...
        if (april_tag.getTagOfInterest().id == april_tag.LEFT || april_tag.getTagOfInterest() == null) RR.runP1();
        else if (april_tag.getTagOfInterest().id == april_tag.RIGHT) RR.runP3();
        else  RR.runTOMID();
