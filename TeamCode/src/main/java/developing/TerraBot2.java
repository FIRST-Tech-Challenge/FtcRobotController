...
public class TerraBot2 {
    ...
    public RobotFunctionsHandler2 rfh1 = new RobotFunctionsHandler2();

    //Automodule for shooting
    public AutoModule2 shooter = new AutoModule2();

    //Automodule for wobble goal
    public AutoModule2 wobbleGoal = new AutoModule2();

    //Automodule for powershot
    public AutoModule2 powerShot = new AutoModule2();
    //List of automodules
    public ArrayList<AutoModule2> autoModules = new ArrayList<>();
