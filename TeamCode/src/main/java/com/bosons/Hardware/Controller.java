...
public class Controller{
    ...
    public boolean onButtonPress(Button input){
        switch (input){
            ...
            case dPadUp:
                return(this.GamePad.dpad_up&&!this.was_dup);
            case dPadDown:
                return(this.GamePad.dpad_down&&!this.was_ddown);
            case dPadRight:
                return(this.GamePad.dpad_right&&!this.was_dright);
            case dPadLeft:
                return(this.GamePad.dpad_left&&!this.was_dleft);
            default:
                return(false);
        }
    }
