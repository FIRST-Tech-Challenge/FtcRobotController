...
public class Outtake {
    ...
    public static final double OUTTAKE_PIVOT_BASKET_POS = 0.93; //increase to lower decrease to go higher
    ...
    public static final double OUTTAKE_PIVOT_TRANSFER_READY_POS = 0.41; //0.4       //increase to go pivot up,
    // decrease to pivot down
...
//    public static final double OUTTAKE_PIVOT_SPECIMAN_HANG_POS = 0.8;   //decrease to go towards robot, increase to do away from robot
    ...
    public static final double LS_SPECIMEN_PARK_MM = 121;
