...
public class Outtake {
    ...
    public static final double OUTTAKE_PIVOT_TRANSFER_READY_POS = 0.40;         //increase to go pivot up, decrease
    // to pivot down
...
//    public static final double OUTTAKE_PIVOT_SPECIMAN_HANG_POS = 0.8;   //decrease to go towards robot, increase to do away from robot
    ...
    public static final double LS_SAMPLE_BASKET_READY_POS = 675 + 40 + 16;
