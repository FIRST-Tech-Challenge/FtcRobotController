...
public class WallToBarHangRoundTrip extends KActionSet {
    ...
    public WallToBarHangRoundTrip(DriveTrain driveTrain, WheelOdometry wheelOdometry, Outtake outtake,
        ...
        moveWallToBar.setDependantActions(waitAtWall);
        ...
        specimenHangReady.setDependantActions(waitAtWall);
        this.addAction(specimenHangReady);

        MoveLSAction lowerSlidesHalf = new MoveLSAction(outtake, 200);
        lowerSlidesHalf.setName("lowerSlidesHalf");
        lowerSlidesHalf.setDependantActions(specimenHangReady, moveWallToBar);
        ...
        openClaw.setDependantActions(lowerSlidesHalf);
        ...
        specimenWallReady.setDependantActions(lowerSlidesHalf);
        ...
        moveBarToWall.setDependantActions(lowerSlidesHalf, openClaw);
