...
public class AutoBlue extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        if(rf.ringnum.equals(RingNum.ZERO)){
            ...
            path.addSetpoint(-12,20,-103);
            dropWobble();
            path.addWaypoint(40, -25, 10);
            ...
            path.addSetpoint(-5,30,0);
            dropWobble();
            path.addWaypoint(20,25,0);
            ...
            path.addRF(rf.changeKs(1, path), rf.lift(0), rf.shootControl(1), rf.intake(1));
            ...
            path.addRF(rf.intake(0), rf.lift(1), rf.changeOuttakePow(0.9, vs, path), rf.toggleOuttake(bot), rf.grab(1));
            path.addStop(0.5);
            path.addRF(rf.wobbleArm(100, 1));
            path.addStop(0.3);
            path.addRF(rf.changeKs(1.3, path));
            path.addSetpoint(-30, 78, 3);
            path.addRF(rf.changeKs(1, path));
            path.addStop(0.6);
            path.addRF(rf.shootControl(3));
            path.addStop(1);
            path.addRF(rf.toggleOuttake(bot), rf.changeAcc(3, 3, 3, path));
            path.addSetpoint(5, 40, 180);
            dropWobble();
            path.addStop(1);
