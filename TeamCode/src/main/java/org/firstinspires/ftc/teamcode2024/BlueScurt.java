...
@Autonomous(name="Autonomie bazata albastru scurt", group="Linear Opmode")
public class BlueScurt extends GlobalScope2024 {
    int pozitie = 0;
    int cx = 0, cy = 0;
    double maxArea = 0;
    OpenCvWebcam webcam;
    ...
    public void runOpMode() {
        ...
        TrajectorySequence t2 = drive.trajectorySequenceBuilder(tfirst.end())
                ...
                .lineTo(new Vector2d(24.5, 35.75))
                .build();
        ...
        TrajectorySequence t3 = drive.trajectorySequenceBuilder(tfirst.end())
                ...
                .lineTo(new Vector2d(32.8, 21))
                .turn(Math.toRadians(-90))
                .lineTo(new Vector2d(32.8, 35.75))
                .build();

        TrajectorySequence t1 = drive.trajectorySequenceBuilder(tfirst.end())
                .lineTo(new Vector2d(30, 12.2))
                .addDisplacementMarker(() -> {
                    SPixel.setPosition(0.4);
                })
                .lineTo(new Vector2d(30, 28))
                .lineTo(new Vector2d(18.5, 28))
                .turn(Math.toRadians(-90))
                .lineTo(new Vector2d(18.5, 35.75))
                .build();

        TrajectorySequence ParkingMaster1_1 = drive.trajectorySequenceBuilder(t1.end())
                .lineTo(new Vector2d (3, 30))
