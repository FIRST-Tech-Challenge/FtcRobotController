...
@Autonomous(name="Autonomie bazata rosu scurt", group="Linear Opmode")
public class RedScurt extends GlobalScope2024 {
    int pozitie = 0;
    int cx = 0, cy = 0;
    double maxArea = 0;
    OpenCvWebcam webcam;
    ...
    public void runOpMode() {
        ...
        class SamplePipeline extends OpenCvPipeline {
            ...
            public Mat processFrame(Mat input) {
                ...
                if (true) {
                    ...
                    Scalar lowerRed = new Scalar(50, 50, 150);
                    Scalar upperRed = new Scalar(130, 100, 255);
        ...
        TrajectorySequence ParkingMaster1_1 = drive.trajectorySequenceBuilder(t1.end())
                .lineTo(new Vector2d (3, -37))
                .lineTo(new Vector2d (3, -48))
                .build();
        ...
        if (pozitie == 2 || pozitie == 0)
        {
           ...
           // sleep(600);
            ...
            SCutie.setPosition(0.36);
            drive.followTrajectorySequence(ParkingMaster2_1);
        }
        else if (pozitie == 1)
        {
            telemetry.addData("pozitie " , 1);
            telemetry.update();
            drive.followTrajectory(tfirst);
           ...
           // sleep(600);
            ...
            SCutie.setPosition(0.36);
            drive.followTrajectorySequence(ParkingMaster1_1);
        }
        else if (pozitie == 3)
        {
            telemetry.addData("pozitie " , 3);
            telemetry.update();
            drive.followTrajectory(tfirst);
           ...
           // sleep(600);
            ...
            SCutie.setPosition(0.36);
            drive.followTrajectorySequence(ParkingMaster3_1);
        }

        VolerLaPosition.currentPose = drive.getPoseEstimate();
