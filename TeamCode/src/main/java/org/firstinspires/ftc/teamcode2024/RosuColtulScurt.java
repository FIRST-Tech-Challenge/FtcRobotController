...
@Autonomous(name="Rosu coltul scurt", group="Linear Opmode")
public class RosuColtulScurt extends GlobalScope2024
{
    int pozitie = 0;
    int cx = 0, cy = 0;
    double maxArea = 0;
...
//
//        Trajectory rosu1 = drive.trajectoryBuilder(startPose)
//                .forward(20)
//                .build();
//
//        TrajectorySequence miscare = drive.trajectorySequenceBuilder(rosu1.end())
//                .lineToLinearHeading()
//                .build();
////
//        drive.turn(Math.toRadians(-90));
//
//        Trajectory rosu2 = drive.trajectoryBuilder(rosu1.end().plus(new Pose2d(0,0,Math.toRadians(-90))))
//                .forward(5)
//                .build();
//
//        TrajectorySequence servo = drive.trajectorySequenceBuilder(rosu2.end())
//                .lineTo(new)
...
//                })
//                .build();
//        Trajectory rosu3 = drive.trajectoryBuilder(rosu2.end()) //x 20  y 5
//                .lineTo(new Vector2d(28,20))
//                .build();

        //----------------------------------------------------

        TrajectorySequence bazatus2 = drive.trajectorySequenceBuilder(new Pose2d(11.61, -67.05, Math.toRadians(90.00)))
                .lineTo(new Vector2d(11.82, -31.97))
                .build();

        TrajectorySequence bazatus1 = drive.trajectorySequenceBuilder(new Pose2d(11.61, -67.05, Math.toRadians(90.00)))
                .lineTo(new Vector2d(11.82,-40.05))
                .lineTo(new Vector2d(-3.25,-40.05))
                .build();
        ...
        TrajectorySequence b2 = drive.trajectorySequenceBuilder(bazatus2.end())
                ...
                .lineTo(new Vector2d(47.82, -37.95))
                .setReversed(true)
                .build();

        TrajectorySequence b1 = drive.trajectorySequenceBuilder(bazatus1.end())
                .lineTo(new Vector2d(47.82, -30.40))
                .setReversed(true)
                .build();

        TrajectorySequence bazatus3 = drive.trajectorySequenceBuilder(new Pose2d(11.61, -67.05, Math.toRadians(90.00)))
                .lineTo(new Vector2d(11.82, -37.95))
                .lineTo(new Vector2d(22.50, -37.95))
                .build();

        TrajectorySequence b3 = drive.trajectorySequenceBuilder(bazatus3.end())
                .lineTo(new Vector2d(47.82, -43.69))
                .build();
