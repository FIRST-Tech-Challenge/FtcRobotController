...
@Autonomous(name="Rosu coltul lung", group="Linear Opmode")
public class RosuColtulLung extends GlobalScope2024
{
    int pozitie = 0;
    int cx = 0, cy = 0;
    double maxArea = 0;
