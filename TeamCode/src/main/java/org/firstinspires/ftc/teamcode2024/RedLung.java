...
@Autonomous(name="Autonomie bazata rosu lung", group="Linear Opmode")
public class RedLung extends GlobalScope2024 {
    int pozitie = 0;
    int cx = 0, cy = 0;
    double maxArea = 0;
    OpenCvWebcam webcam;
    ...
    public void runOpMode() {
        ...
        TrajectorySequence t2 = drive.trajectorySequenceBuilder(tfirst.end())
                ...
                .lineTo(new Vector2d(25.3, -50)) //29 pentru stanga
                .lineTo(new Vector2d(25.3, -80.2))
        ...
        TrajectorySequence t1 = drive.trajectorySequenceBuilder(tfirst.end())
                ...
                .lineTo(new Vector2d(50, -50))
                .turn(Math.toRadians(90))
                .lineTo(new Vector2d(34.1, -50)) //29 pentru stanga
                .lineTo(new Vector2d(34.1, -80.5)) // -80.2, -80.5
                      //  SampleMecanumDrive.getVelocityConstraint(10, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH),
                      //  SampleMecanumDrive.getAccelerationConstraint(DriveConstants.MAX_ACCEL))
                .build();

        TrajectorySequence t3 = drive.trajectorySequenceBuilder(tfirst.end())
                .lineTo(new Vector2d(26.7, -10))
                .addDisplacementMarker(() -> {
                    SPixel.setPosition(0.4);
                })
                ...
                .lineTo(new Vector2d(50, -50))
                .turn(Math.toRadians(90))
                .lineTo(new Vector2d(17.75, -50))
                .lineTo(new Vector2d(17.75, -80.5)) //-80.2, -80.5
                     //   SampleMecanumDrive.getVelocityConstraint(10, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH),
                      //  SampleMecanumDrive.getAccelerationConstraint(DriveConstants.MAX_ACCEL))
                .build();
