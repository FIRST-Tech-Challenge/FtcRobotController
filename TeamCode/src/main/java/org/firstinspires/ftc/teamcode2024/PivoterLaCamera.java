...
@TeleOp(name="PivoterLaCamera", group="Linear Opmode")
public class PivoterLaCamera extends GlobalScope2024
{
    int pozitie = 0;
    int cx = 0, cy = 0;
    double maxArea = 0;
    ...
    public void runOpMode() {
        ...
        while (opModeIsActive())
        {
            ...
            telemetry.addData("pozitia camerei este : ", poz);
            telemetry.update();
            SCamera.setPosition(poz);
        }
    }
