...
@TeleOp(name = "OdomTest", group = "hardwareTest")
public class OdomTest extends UpliftTele {
    ...
    public void bodyLoop() {
        ...
        telemetry.addData("x", robot.worldX);
        telemetry.addData("y", robot.worldY);
        telemetry.addData("angle", robot.worldAngle);
        telemetry.addData("imuAngle", robot.imuAngle);
        telemetry.addData("leftEncoder", robot.odometry.getLeftTicks() / UpliftRobot.COUNTS_PER_INCH);
        telemetry.addData("rightEncoder", robot.odometry.getRightTicks() / UpliftRobot.COUNTS_PER_INCH);
        telemetry.addData("centerEncoder", robot.odometry.getCenterTicks() / UpliftRobot.COUNTS_PER_INCH);
        telemetry.update();
