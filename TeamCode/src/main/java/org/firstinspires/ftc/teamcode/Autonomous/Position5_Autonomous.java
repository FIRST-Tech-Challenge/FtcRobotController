...
@Autonomous(name = "Position5_Autonomous (Blocks to Java)")
public class Position5_Autonomous extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        waitForStart();
        sleep(1000);
        // Put function below this comment-- FUNCTION OPTIONS: 1. "Position 5 Parking 1" 2. "Position 5 Parking 2" 3. "Position 5 Parking 3"
        Position_5_Parking_3();
        while (opModeIsActive()) {
            ...
            telemetry.addData("Right Front Postion", rightFront.getCurrentPosition());
     ...
     * Describe this function...
     */
    private void Position_5_Parking_2() {
     ...
     * Describe this function...
     */
    private void Position_5_Parking_3() {
        drive(-1050, 1050, 1050, -1050, 0.25);
        sleep(1000);
        reset_values();
        sleep(1000);
     ...
     * Describe this function...
     */
    private void Position_5_Parking_1() {
        drive(-1050, 1050, 1050, -1050, 0.25);
        sleep(1000);
        reset_values();
        sleep(1000);
