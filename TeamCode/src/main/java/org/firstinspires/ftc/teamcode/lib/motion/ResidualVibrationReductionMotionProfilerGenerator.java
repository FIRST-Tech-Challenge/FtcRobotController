...
public class ResidualVibrationReductionMotionProfilerGenerator implements IMotionProfile {
    ...
    private static final ResidualVibrationReductionMotionProfilerGenerator[] STANDARD_POLE_MOTION_PROFILES;
    ...
    static {
        STANDARD_MOTION_PROFILES = new ResidualVibrationReductionMotionProfilerGenerator[10];
        STANDARD_POLE_MOTION_PROFILES = new ResidualVibrationReductionMotionProfilerGenerator[8];
    }
...
//    }
    ...
    public static void init() {
        for(int i = 0; i < STANDARD_MOTION_PROFILES.length / 2; i++) {
            //STANDARD_MOTION_PROFILES[i] = new ResidualVibrationReductionMotionProfilerGenerator(0d, StackTracker.getExtensionHeight(i + 1), 20d * 6d, 200d * 6d);
            STANDARD_MOTION_PROFILES[i] = new ResidualVibrationReductionMotionProfilerGenerator(0d, StackTracker.getExtensionHeight(i), 12d, 50d);
            //STANDARD_MOTION_PROFILES[i + STANDARD_MOTION_PROFILES.length / 2] = new ResidualVibrationReductionMotionProfilerGenerator(StackTracker.getExtensionHeight(i + 1), -StackTracker.getExtensionHeight(i + 1), 40d * 6d, 400d * 6d);
            STANDARD_MOTION_PROFILES[i + STANDARD_MOTION_PROFILES.length / 2] = new ResidualVibrationReductionMotionProfilerGenerator(StackTracker.getExtensionHeight(i), -StackTracker.getExtensionHeight(i), 50d, 75d);
        }
        //POLES
        for (int j = 0; j < STANDARD_POLE_MOTION_PROFILES.length / 2; j++){
            STANDARD_POLE_MOTION_PROFILES[j] = new ResidualVibrationReductionMotionProfilerGenerator(0d,StackTracker.getPoleExtensionHeight(j),12d,50d);
            STANDARD_POLE_MOTION_PROFILES[j + STANDARD_POLE_MOTION_PROFILES.length / 2] = new ResidualVibrationReductionMotionProfilerGenerator(StackTracker.getPoleExtensionHeight(j), -StackTracker.getPoleExtensionHeight(j), 50d, 75d);
        }
    }
    ...
    public static ResidualVibrationReductionMotionProfilerGenerator[] getStandardPoleMotionProfiles() {
        return STANDARD_POLE_MOTION_PROFILES;
    }
}
