...
//    Orientation angles; //feedback from the IMU
    ...
    private double cannonOn = 1;
    private double cannonOff = .5;
...
//    public GlyphSystem glyphSystem;
     ...
     */
    public PoseSurtr(double x, double y, double heading, double speed)
    {
     ...
     */
    public PoseSurtr(double x, double y, double angle)
    {
...
//        this.glyphSystem = new GlyphSystem(motorLift, servoGripRight, motorGripLeft, motorGripRight, servoLiftLeft, servoLiftRight, servoPhone);
    ...
    public void stopCannon(){
        isCannonOn = false;
        cannon.setPosition(cannonOff);
    }

    public void startCannon(){
        isCannonOn = true;
        cannon.setPosition(cannonOn);
    }
