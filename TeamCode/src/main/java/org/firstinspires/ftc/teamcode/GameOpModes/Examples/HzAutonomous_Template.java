 ...
 */
@Autonomous(name = "Hazmat Platform Autonomous Template", group = "00-Autonomous" , preselectTeleOp = "Hazmat TeleOp")
@Disabled
public class HzAutonomous_Template extends LinearOpMode {
