...
@Config
public class Lift {
    public static int MAX_LIFT_TICKS = 1340;
...
//    }
    ...
    double[] coneStack = {500*0.6+30,410*0.6+10,315*0.6-10,180*0.6 - 30};
    ;
    ...
    public enum LiftConstants {
        LIFT_HIGH_JUNCTION(MAX_LIFT_TICKS - 50, false),
        LIFT_MED_JUNCTION(860*.8+20, false),
