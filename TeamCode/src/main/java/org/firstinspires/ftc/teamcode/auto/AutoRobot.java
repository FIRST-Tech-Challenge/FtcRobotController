        ...
        public class AutoRobot {
            ...
            public void driveArcLeftForwards(double degrees) {
                driveArcLeftForwards(degrees, 1, MovementCurves.ROUNDEDSQUARE);
            }

            public void driveArcLeftForwards(double degrees, double powerMultiplier) {
                driveArcLeftForwards(degrees, powerMultiplier, MovementCurves.ROUNDEDSQUARE);
            }
            ...
            public void driveArcRightForwards(double degrees) {
                driveArcRightForwards(degrees, 1, MovementCurves.ROUNDEDSQUARE);
            }

            public void driveArcRightForwards(double degrees, double powerMultiplier) {
                driveArcRightForwards(degrees, powerMultiplier, MovementCurves.ROUNDEDSQUARE);
            }
