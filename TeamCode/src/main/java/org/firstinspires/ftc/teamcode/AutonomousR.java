/* FTC Team 7572 - Version 1.0 (11/12/2021)
*/
...
public class AutonomousR extends LinearOpMode {
    ...
    private boolean teamNumber1     = true;  // default to left side (closest to duck carousel)
    ...
    public void runOpMode() throws InterruptedException {
        ...
        while (!isStarted()) {
            if( gamepad1.left_bumper  ) teamNumber1 = true;   // left side
            if( gamepad1.right_bumper ) teamNumber1 = false;  // right side
            ...
            telemetry.addData("Start Position (L/R bumper)", "%s", (teamNumber1)? "LEFT":"RIGHT");
...
//      testGyroDrive();
    ...
    private void moveToHub( int level ) {
        ...
        switch( level ) {
            case 3 : distanceToHub = 8.2; // top
                     break;
            case 2 : distanceToHub = 4.5; // middle
                     break;
            case 1 : distanceToHub = 5.5; // bottom
                     break;
        } // switch()
        ...
        gyroTurn(TURN_SPEED_25, (getAngle() + 30.0) );   // Turn CW 30 Degrees
        robot.freightArmPosition( robot.FREIGHT_ARM_POS_TRANSPORT2, 0.30 );
    ...
    private void spinDuckCarousel( int level ) {
        ...
        sleep( 3000 );                                   // Spin the carousel for 3 seconds
...
//          telemetry.update();
    ...
    class FreightFrenzyPipeline extends OpenCvPipeline
    {
        ...
        private Point sub1PointA = new Point(30, 190);  // 15x15 pixels on LEFT stone
        private Point sub1PointB = new Point(45, 205);
        private Point sub2PointA = new Point(150, 190); // 15x15 pixels on CENTER stone (col 160)
        private Point sub2PointB = new Point(165, 205);
        private Point sub3PointA = new Point(260, 190); // 15x15 pixels on RIGHT stone
        private Point sub3PointB = new Point(275, 205);
