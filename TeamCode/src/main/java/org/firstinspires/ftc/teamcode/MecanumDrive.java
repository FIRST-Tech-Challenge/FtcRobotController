...
//            Pose2d error = txWorldTarget.value().minusExp(pose);
    ...
    /**
     * Used to rebase the drivetrain, such as after driving to an AprilTag.
     * @return Action for use within an  Action sequence
     */
    public Action rebasePose(Pose2d updatedPose) {
        return new Action() {
