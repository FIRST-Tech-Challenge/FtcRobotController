...
import org.nknsd.robotics.team.programs.PotentiometerProgram;
import org.nknsd.robotics.team.programs.VisionSensorTester;

import java.util.concurrent.TimeUnit;

@TeleOp(name = "Vision Tester")
public class NKNOpMode_VisionTest extends OpMode {
    ...
    private final NKNProgram program = new VisionSensorTester();
