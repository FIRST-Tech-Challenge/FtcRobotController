...
public class RedRightPWarehouse extends LinearOpMode {
    ...
    public void runOpMode(){
        ...
        waitForStart();
        robot.goToPosition(0,-13.5,0,0,0.5);
        ...
        if(position==2) {
            robot.TurretSlidesToPosition(.24, .3, 0, 0.5,false);
            sleep(1300);
        ...
        if(position==0){
            robot.TurretSlidesToPosition(.8, 1.2, 0, 0.5,false);
            sleep(1300);
