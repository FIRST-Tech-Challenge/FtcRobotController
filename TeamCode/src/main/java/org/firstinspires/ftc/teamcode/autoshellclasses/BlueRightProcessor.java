...
public class BlueRightProcessor implements VisionProcessor, CameraStreamSource {
    ...
    // JOSHUANOTE: Is this where i change the camera box dimensions? Who knows?
    ...
    public void init(int width, int height, CameraCalibration calibration) {
       ...
       */
        // JOSHUANOTE: change the box sizes and number of here. remember that left is the default case.
     ...
     */
    // JOSHUANOTE: change the box detection color here.
    public void setDetectionColor(boolean detectBlue) {
        this.detectingRed = detectBlue;
    }
...
//     finalMat.copyTo(frame);
        ...
        // JOSHUANOTE: This is where to change the camera output cases
        switch (propLocation) {
            case LEFT:
...
//     return null; //You do not return the original mat anymore, instead return null
    ...
    // JOSHUANOTE: Change prop positions here
