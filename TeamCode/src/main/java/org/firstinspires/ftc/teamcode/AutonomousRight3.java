...
/**
 */
@Autonomous(name="Right: clip 3 (63 pts)", group="7592", preselectTeleOp = "Teleop")
//@Disabled
public class AutonomousRight3 extends AutonomousBase {
...
//      timeArmMovement();
    ...
    private void grabSpecimenFromWall( int specimenNumber ) {
        ...
        if( opModeIsActive() ) {
           driveToPosition( 10.0, 7.0, 90.0, DRIVE_SPEED_100, TURN_SPEED_80, DRIVE_THRU );
        } // opModeIsActive
