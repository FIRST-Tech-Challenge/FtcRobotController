...
public class BoardOpMode extends OpMode {
    ...
    public Encoder leftOdometry;
    public Encoder rightOdometry;
    //ENUMS=====================================================================================================================
    ...
    public void init() {
        ...
        leftOdometry = new OverflowEncoder(new RawEncoder(hardwareMap.get(DcMotorEx.class, "fl")));
        rightOdometry = new OverflowEncoder(new RawEncoder(hardwareMap.get(DcMotorEx.class, "fr")));
    ...
    public void loop() {
        ...
        telemetry.addLine("\t Left Odometry Pod position:" + leftOdometry.getPositionAndVelocity().rawPosition);
        telemetry.addLine("\t Right Odometry Pod position:" + rightOdometry.getPositionAndVelocity().rawPosition);
