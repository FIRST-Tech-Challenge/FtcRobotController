...
public class FollowerConstants {
    ...
    private static double xMovement = 68.357;
    private static double yMovement = 52.4643;
    ...
    public static double mass = 9.888;
    ...
    public static double forwardZeroPowerAcceleration = -28.448;

    // Acceleration of the drivetrain when power is cut in inches/second^2 (should be negative)
    // if not negative, then the robot thinks that its going to go faster under 0 power
    public static double lateralZeroPowerAcceleration = -64.308;
