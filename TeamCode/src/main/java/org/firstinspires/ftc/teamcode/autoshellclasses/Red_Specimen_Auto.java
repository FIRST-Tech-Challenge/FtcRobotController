...
public class Red_Specimen_Auto extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        Pose2d initialPose = new Pose2d(14.5, -64, Math.toRadians(90));
        ...
        driveToClip1 = drive.actionBuilder(drive.pose)
                ...
                .build();
        driveToClip2 = drive.actionBuilder(new Pose2d(51,-57,-135))
                .strafeToLinearHeading(new Vector2d(2, -48), Math.toRadians(90))
                .build();
        driveToClip3 = drive.actionBuilder(new Pose2d(38,-58,0))
        ...
        clippingSpecimen2 = drive.actionBuilder(new Pose2d(2,-48,90))
                ...
                .build();
        clippingSpecimen3 = drive.actionBuilder(new Pose2d(4,-48,90))
        ...
        grabSpecimen3 = drive.actionBuilder(new Pose2d(2,-36,90))
                .strafeToLinearHeading(new Vector2d(38,-58), Math.toRadians(0))
                .build();

        driveToPark = drive.actionBuilder(new Pose2d(4,-36,90))
