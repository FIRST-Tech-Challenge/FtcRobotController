...
/** Initial Team B composition using safe shared baseline components. */
public class TeamBRobot extends Robot {
    ...
    public TeamBRobot() { this(new RobotHardware()); }
    public TeamBRobot(RobotHardware hardware) {
        if (hardware == null) throw new IllegalArgumentException("Team B robot needs robot hardware.");
    ...
    // TODO: Replace wrappers, directions, and subsystem constants after Team B hardware is known.
    // TODO: Add Team B-specific mechanisms when their geometry is defined.
}
