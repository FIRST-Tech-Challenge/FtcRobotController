...
public class Hobbes extends Meccanum implements Robot {
    ...
    public void setMacros(MARCO mode) {
        switch (mode) {
            case TELEOP:
                macros.put("EXTENDO_BEFORE_PICKUP",
                        new HobbesState(EXTENDO_OUT_SOME, null, null, null, null, INTAKE_POWER, null, null, null));

                macros.put("EXTENDO_ARM_WRIST_FLAT", new HobbesState(null, EXTENDO_ARM_INTAKE,
                        EXTENDO_WRIST_INTAKE_FLAT, null, null, null, null, null, null));

                macros.put("EXTENDO_ARM_WRIST_UP", new HobbesState(null, EXTENDO_ARM_UP, EXTENDO_WRIST_UP, null, null,
                        INTAKE_OFF, null, null, null));

                macros.put("EXTENDO_ARM_WRIST_ANGLED", new HobbesState(null, EXTENDO_ARM_INTAKE_ANGLED,
                        EXTENDO_WRIST_INTAKE_ANGLED, null, null, null, null, null, null));

                macros.put("FULL_IN", new HobbesState(EXTENDO_IN, EXTENDO_ARM_TRANSFER, EXTENDO_WRIST_TRANSFER,
                        SLIDES_ARM_ABOVE_TRANSFER, SLIDES_WRIST_TRANSFER, INTAKE_OFF, CLAW_OPEN, SLIDES_IN, null));

                macros.put("FULL_TRANSFER",
                        new HobbesState(EXTENDO_IN, EXTENDO_ARM_TRANSFER, EXTENDO_WRIST_UP, SLIDES_ARM_ABOVE_TRANSFER,
                                SLIDES_WRIST_TRANSFER, INTAKE_OFF, CLAW_OPEN, SLIDES_IN,
                                new LinkedState("TRANSFER_WRIST_UP", 600)));
                macros.put("TRANSFER_WRIST_UP",
                        new HobbesState(EXTENDO_IN, EXTENDO_ARM_TRANSFER, EXTENDO_WRIST_TRANSFER,
                                SLIDES_ARM_ABOVE_TRANSFER, SLIDES_WRIST_TRANSFER, INTAKE_OFF, CLAW_OPEN, SLIDES_IN,
                                new LinkedState("TRANSFER_ON", 200)));
                macros.put("TRANSFER_ON",
                        new HobbesState(EXTENDO_IN, EXTENDO_ARM_TRANSFER, EXTENDO_WRIST_TRANSFER, SLIDES_ARM_TRANSFER,
                                SLIDES_WRIST_TRANSFER, INTAKE_OFF, CLAW_OPEN, SLIDES_IN,
                                new LinkedState("TRANSFER_CLOSED", 250)));
                macros.put("TRANSFER_CLOSED", new HobbesState(EXTENDO_IN, EXTENDO_ARM_TRANSFER, EXTENDO_WRIST_TRANSFER,
                        SLIDES_ARM_TRANSFER, SLIDES_WRIST_TRANSFER, INTAKE_OFF, CLAW_CLOSED, SLIDES_IN, null));

                macros.put("SLIDES_DOWN", new HobbesState(null, null, null, SLIDES_ARM_ABOVE_TRANSFER,
                        SLIDES_WRIST_TRANSFER, null, CLAW_OPEN, SLIDES_IN, null));

                macros.put("SLIDES_DEPOSIT", new HobbesState(null, null, null, null, null, null, null,
                        SLIDES_OUT_TOP_SAMPLE, new LinkedState("SLIDES_DEPOSIT2", 1200)));
                macros.put("SLIDES_DEPOSIT2", new HobbesState(null, null, null, SLIDES_ARM_DEPOSIT,
                        SLIDES_WRIST_DEPOSIT, null, null, null, null));
