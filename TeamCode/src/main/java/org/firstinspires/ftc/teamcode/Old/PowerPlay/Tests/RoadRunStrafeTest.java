...
//140/8092 * 6.28
@Disabled
@Autonomous(name = "RoadRunStrafeTest")
public class RoadRunStrafeTest extends LinearOpMode {
...
//                .build();
        TrajectorySequence trajSeq2 = robot.roadrun.trajectorySequenceBuilder(new Pose2d(35.25,57.75, Math.toRadians(270)))
                .lineToSplineHeading(new Pose2d(13.75, 57.75,Math.toRadians(270)), SampleMecanumDrive.getVelocityConstraint(10,3,51.564/5),
