...
@TeleOp(name = "TeleOpFinal-RCPID")
public class telMecBothDrOpt_twoP_RoboCentPIDLift extends LinearOpMode {
...
//Based on testing, the front and back left motors were reversed.  Reversing them here (FIXED THE ISSUE!!!)
        ...
        PixelLifter lifter = new PixelLifter(lifterMotor,0,-200,-1025,-1800,.3);
