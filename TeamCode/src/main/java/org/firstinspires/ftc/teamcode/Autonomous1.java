/* FTC Team 7572 - Version 1.0 (10/30/2021)
*/
 ...
 */
@Autonomous(name="Autonomous1 (Red)", group="7592")
//@Disabled
public class Autonomous1 extends LinearOpMode {
    ...
    static final double  DRIVE_SPEED_20       = 0.20;    // When approaching the build platform, go slow
    static final double  TURN_SPEED_25        = 0.25;    // Nominal half speed for better accuracy.

    static final double  HEADING_THRESHOLD    = 1.0;     // Minimum of 1 degree for an integer gyro
 ...
 //     mainAutonomous();
    ...
    private void mainAutonomous() {
        ...
        if( opModeIsActive() ) {
            telemetry.addData("Motion", "moveToDuckCarousel");
            telemetry.update();
            moveToDuckCarousel();
        }

        // Enable the carousel motor

        // Spin the carousel for 2.5 seconds
        sleep(2500 );

        // Disable carousel motor
...
//          driveToWarehouse();
    ...
    /*--------------------------------------------------------------------------------------------*/
    private void moveToDuckCarousel() {
        gyroDrive(DRIVE_SPEED_40, DRIVE_Y, -24.0, 999.9, DRIVE_THRU );  // Drive FWD 24" along current heading
        gyroTurn(TURN_SPEED_25, (getAngle() + 90.0) );       // Turn CCW 90 Degrees
        gyroDrive(DRIVE_SPEED_55, DRIVE_Y, -60.0, 999.9, DRIVE_THRU );  // Drive FWD 60" along current heading
        gyroDrive(DRIVE_SPEED_40, DRIVE_Y, -8.0, 999.9, DRIVE_THRU );   // Drive FWD 8" along current heading
        gyroDrive(DRIVE_SPEED_20, DRIVE_Y, -4.0, 999.9, DRIVE_TO );     // Drive FWD 4" along current heading
    } // moveToDuckCarousel
