...
public class RoadRunnerSubsystem_RED {
    ...
    -Params-
    -------------------------------------------------------*/
    protected final double Tile = 24; /*-inches-*/
    protected final double TileInverted = -24; /*-inches-*/
    protected final double RobotX = 12.5984252; /*-inches-*/
    protected final double RobotY = 16.9291339; /*-inches-*/
    protected final double BackdropDistance = 0; /*-inches-*/
    /*-------------------------------------------------------
    -Trajectories-
    -------------------------------------------------------*/
