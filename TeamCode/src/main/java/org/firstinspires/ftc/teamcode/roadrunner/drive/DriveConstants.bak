 ...
 *
 * <p>Constants generated by LearnRoadRunner.com/drive-constants
 *
 * <p>TODO: Tune or adjust the following constants to fit your robot. Note that the non-final
 * fields may also be edited through the dashboard (connect to the robot's WiFi network and
 * navigate to https://192.168.49.1:8080/dash). Make sure to save the values here after you
 * adjust them in the dashboard; ////config variable changes don't persist between app restarts////.
 *
 * <p>These are not the only parameters; some are located in the localizer classes, drive base classes,
...
public class DriveConstants {
    ...
    public static double TRACK_WIDTH = 14.84; // in

    // These are the feedforward parameters used to model the drive motor behavior. If you are using
    // the built-in velocity PID, //these values are fine as is//. However, if you do not have drive
    // motor encoders or have elected not to use them for velocity control, these values should be
    // empirically tuned.
    public static double kV = .0135;
