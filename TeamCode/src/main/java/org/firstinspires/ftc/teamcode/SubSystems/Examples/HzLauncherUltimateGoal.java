...
height of target.
 */
public class HzLauncherUltimateGoal {
    ...
    public double FLYWHEEL_NOMINAL_VELOCITY_HIGH_GOAL = 1460;//1500;
    public double FLYWHEEL_NOMINAL_VELOCITY_POWERSHOT = 1360;//1400;
    public double FLYWHEEL_BATTERY_CORRECTION = 30;
    ...
    public HzLauncherUltimateGoal(HardwareMap hardwareMap) {
        ...
        launcherFlyWheelMotor.setVelocityPIDFCoefficients(8.0, 0.163835, 0, 15.5);
