...
import org.firstinspires.ftc.teamcode.VirtualDevice;
...
public class SlidingArmVD extends VirtualDevice implements ConfigMan, Configurable {
    ...
    public SlidingArmVD(Manufacturer manufacturer, String partNumber, String DeviceName, HashMap<String, Object> connectionPortScheme, int version,DcMotorEx drivingMotor) {
        super( partNumber, DeviceName, connectionPortScheme, version);
        motor = drivingMotor;
    }
    public SlidingArmVD( String partNumber, String DeviceName, HashMap<String, Object> connectionPortScheme, int version,DcMotorEx drivingMotor) {
        super(partNumber, DeviceName, connectionPortScheme, version);
        motor = drivingMotor;
    }
    public SlidingArmVD(Manufacturer manufacturer, String partNumber, String DeviceName, HashMap<String, Object> connectionPortScheme, int version,DcMotorEx drivingMotor, HashMap<String,String> configurationOptions) {
        super( partNumber, DeviceName, connectionPortScheme, version);
        motor = drivingMotor;
