...
//
//        motorPower[0] = constants.MAX_VELOCITY_DT * speed * (spinPower * translationPowerPercentage * translateSwitchMotors * leftThrottle + leftRotatePower * rotationPowerPercentage * leftRotationSwitchMotors); //top left
//        motorPower[1] = constants.MAX_VELOCITY_DT * speed * (-1 * spinPower * translationPowerPercentage * translateSwitchMotors * leftThrottle + leftRotatePower * rotationPowerPercentage * leftRotationSwitchMotors); //bottom left
//        motorPower[2] = constants.MAX_VELOCITY_DT * speed * (spinPower * translationPowerPercentage * translateSwitchMotors * rightThrottle + rightRotatePower * rotationPowerPercentage * rightRotationSwitchMotors); //top right
//        motorPower[3] = constants.MAX_VELOCITY_DT * speed * (-1 * spinPower * translationPowerPercentage * translateSwitchMotors + rightRotatePower * rightThrottle * rotationPowerPercentage * rightRotationSwitchMotors); //bottom right
//
//        return motorPower;
//    }
//
