...
public class HzGamepadTestControllerUltimateGoal {
     ...
     */
    public HzGamepadTestControllerUltimateGoal(Gamepad gamepadPassedfromOpMode/*, LinearOpMode opModepassedfromOpMode*/) {
