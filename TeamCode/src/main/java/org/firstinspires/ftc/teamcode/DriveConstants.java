...
public class DriveConstants {
    ...
    public static PIDFCoefficients MOTOR_VELO_PID = new PIDFCoefficients(10, 1, 0,
    ...
    public static double MOTOR_INCHES_PER_TICK = (WHEEL_RADIUS * 2 * Math.PI / TICKS_PER_REV);  // was * and was wrong...
