...
public class RobotContainer extends com.arcrobotics.ftclib.command.Robot {
    ...
    private void configureBinds() {
        ...
        Intake.whenActive(new Intaking(m_extension,m_pivot,m_chassis,m_gripper,m_controller));
        Score.whenActive(new Placing(m_extension,m_pivot,m_chassis,m_gripper,m_controller));
    ...
    private void initSubsytems(HardwareMap map){
