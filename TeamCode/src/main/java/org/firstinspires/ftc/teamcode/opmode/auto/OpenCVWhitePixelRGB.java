...
import org.firstinspires.ftc.teamcode.pipeline.GripPipelineWhitePixelRGB;
import org.openftc.easyopencv.OpenCvCamera;
import org.openftc.easyopencv.OpenCvCameraFactory;
import org.openftc.easyopencv.OpenCvCameraRotation;
import org.openftc.easyopencv.OpenCvWebcam;

@TeleOp(name="White Pixel")
//@Disabled
public class OpenCVWhitePixelRGB extends OpMode {
    static final int STREAM_WIDTH = 1280; // modify for your camera
    static final int STREAM_HEIGHT = 960; // modify for your camera
    OpenCvWebcam webcam;
    GripPipelineWhitePixelRGB pipeline;
    @Override
    public void init() {
        ...
        pipeline = new GripPipelineWhitePixelRGB();
