...
// you call them.
Reference: https://raw.githubusercontent.com/stemrobotics/Tetrix-Exercises/master/Logging.java
        */
...
//            }
    ...
    private static class LogFormatter extends Formatter
    {
        public String format(LogRecord rec)
        {
            ...
            /*String*/ return /*buf =*/ String.format(Locale.getDefault(), "<%d>", rec.getThreadID()) + //Thread.currentThread().getId()));
    ...
    private static void logDevices(@SuppressWarnings("rawtypes") HardwareMap.DeviceMapping deviceMap)
    {
    ...
    public static String getDeviceUserName(@SuppressWarnings("rawtypes") HardwareMap.DeviceMapping deviceMap,
                                           HardwareDevice dev)
    {
        for (Map.Entry<String, HardwareDevice> entry : (Set<Map.Entry<String,HardwareDevice>>) deviceMap.entrySet())
        {
