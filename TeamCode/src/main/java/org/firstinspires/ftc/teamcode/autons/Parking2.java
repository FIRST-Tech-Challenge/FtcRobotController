...
public class Parking2 extends CommandOpMode {
...
//        arm.motor.setZeroPowerBehavior(DcMotor.ZeroPowerBehavior.BRAKE);
        ...
        Trajectory lineTo = drive.trajectoryBuilder(new Pose2d(12.55, -64.31, Math.toRadians(90)))
                .lineToSplineHeading(new Pose2d(7, -36.5, Math.toRadians(180)))
                .build();
        ...
        TrajectoryFollowerCommand autonomous6 = new TrajectoryFollowerCommand(drive, back2);
