...
@Autonomous(name = "DistanceSensorAuton")
public class autonDistanceAttemptTest extends CommandOpMode {
    ...
    public void initialize() {
        ...
        command = new DriveMotorCommand(subsystem, 0.3, 0.3, 0.3, 0.325, 37);
//        turn = new DriveMotorCommand(subsystem, -0.3, -0.3, 0.3, 0.3, 31)
        ...
        schedule(new WaitUntilCommand(this::isStarted)
                ...
                .andThen(command.interruptOn(() -> distance.getDistance(DistanceUnit.INCH) > 37))
