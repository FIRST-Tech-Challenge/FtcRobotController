...
public class RobotActionConfig {
    ...
    public static double deposit_Wrist_Transfer         = 0.52; // 0.06 is rest position.
    public static double deposit_Wrist_Pick             = 0.31; // 0.06 is rest position.
    public static double deposit_Wrist_Hook             = 0.5; // 0.06 is rest position.


    public static double deposit_Arm_Pick               = 0.97; // 0 is pick position.
    ...
    public static double deposit_Arm_Hook               = 0.5;  // deposit arm hook position
