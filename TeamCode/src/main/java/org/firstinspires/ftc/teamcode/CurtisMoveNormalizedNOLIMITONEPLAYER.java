...
public class CurtisMoveNormalizedNOLIMITONEPLAYER extends OpMode {
    //Motors
...
//        Slides.setMode(DcMotor.RunMode.STOP_AND_RESET_ENCODER);
    ...
    public void loop() {
        ...
        // slides
        slidesPower = gamepad1.dpad_right ? MAXSLIDEPOWER : gamepad1.dpad_left ? -MAXSLIDEPOWER : gamepad1.touchpad ? HangPower : 0;
