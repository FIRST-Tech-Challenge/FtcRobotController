...
import static org.firstinspires.ftc.teamcode.FancyTeleop.Hobbes.MARCO.TELEOP;
...
public class HobbesTele extends OpMode {
    ...
    public void loop() {
        ...
        // delete everything in gamepad histories with a 500 cycle delay (prob would make a memory leak if not?)
