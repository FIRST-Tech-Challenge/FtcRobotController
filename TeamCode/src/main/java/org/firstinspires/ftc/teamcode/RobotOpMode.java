...
public abstract class RobotOpMode extends OpMode {
    ...
    public void init() {
        ...
        try {
            ...
            log(ERROR, "Error initializing arm motors: "+e.getMessage());
        }
    ...
    public void moveArm(float power, int position) {
        ...
        // FIXME: This will freeze the entire program whenever the arm moves. Implement a fix that works in a LinearOpMode
        while (armMotor.isBusy()) {
            log("Waiting", "...");
            sendTelemetryPacket(true);
        }
