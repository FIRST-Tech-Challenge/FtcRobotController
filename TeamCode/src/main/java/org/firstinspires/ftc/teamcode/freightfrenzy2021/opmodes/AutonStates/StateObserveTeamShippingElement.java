...
public class StateObserveTeamShippingElement implements EbotsAutonState{
    ...
    Constructors
    ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~*/
    public StateObserveTeamShippingElement(EbotsAutonOpMode autonOpMode){
...
//        this.telemetry.clearAll();
    ...
    public boolean shouldExit() {
        boolean lockoutActive = stopWatchState.getElapsedTimeMillis() < 2000;
    ...
    public void performStateActions() {
        ...
        if (updatedRecognitions != null) {
            ...
            for (Recognition recognition : updatedRecognitions) {
                if (recognition.getLabel() == "Shipele"){
