 ...
 */
@Autonomous(name = "Hazmat Frozen Frenzy Ultimate Goal", group = "00-Autonomous" , preselectTeleOp = "Hazmat TeleOp RR Ultimate Goal")
@Disabled
public class HzAutoFrozenFrenzyUltimateGoal extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        /* Set initial condition to be persistant. Example
        ...
        if (!hzAutonomousController.dropFirstWobbleGoal) {
            ...
            if ((hzAutonomousController.pickRingFromTargetMarker == false) || (targetZone == HzGameFieldUltimateGoal.TARGET_ZONE.A)) { // Park
                ...
                if (hzAutonomousController.launchRingsPickedFromTargetMarkerToHighGoal) {
                    ...
                    traj = driveTrain.trajectoryBuilder(driveTrain.getPoseEstimate())
                            .lineToLinearHeading(new Pose2d(-13, af * 36, Math.toRadians(5)))
                            .build();
                    driveTrain.followTrajectory(traj);
