...
public abstract class CSBase extends LinearOpMode {
     ...
     * @param dir (opt.) Direction to turn if degrees is zero.
     */
    public void turn(double degrees, xDir dir) {
        sleep(100);
        imu.resetYaw();
        double tolerance = 1;
    ...
    public void strafe(double inches, xDir direction /*double duration*/) {
