...
public class OdometryLocalizer implements Runnable {
    ...
    private final double LATERAL_DISTANCE = DistanceUnit.INCH.toCm(15.2); // Measured to the best of my ability
    private final double PERP_TO_CENTER = DistanceUnit.INCH.toCm(0.62
