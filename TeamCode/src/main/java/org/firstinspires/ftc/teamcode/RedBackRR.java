...
@Config
@Autonomous(name = "RedBackRR", group = "Autonomous")
public class RedBackRR extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        trajectoryRightPurple = drive.actionBuilder(drive.pose)
                .splineToLinearHeading(new Pose2d(27,-30,Math.PI),Math.toRadians(90))
                .build();
        trajectoryRightYellow = drive.actionBuilder(new Pose2d(29,-30,Math.PI))
                .setReversed(true)
                .splineToConstantHeading(new Vector2d(53,-48),0)
                .build();
        trajectoryMiddlePurple = drive.actionBuilder(drive.pose)
                .splineToConstantHeading(new Vector2d(12,-28), Math.toRadians(90))
                .build();
        trajectoryMiddleYellow = drive.actionBuilder(new Pose2d(12,-28,Math.toRadians(90)))
                .setReversed(true)
        ...
        trajectoryLeftPurple = drive.actionBuilder(drive.pose)
                .splineToLinearHeading(new Pose2d(15,-33,Math.PI),Math.toRadians(90))
                .setTangent(Math.PI)
                .lineToX(5)
                .build();
        trajectoryLeftYellow = drive.actionBuilder(new Pose2d(5,-33,Math.PI))
                .setReversed(true)
                .splineToConstantHeading(new Vector2d(53,-37),0)
                .build();
        ...
        trajectoryLeftCloseOut = drive.actionBuilder(new Pose2d(53,-36,Math.PI))
                ...
                .build();
        trajectoryMiddleCloseOut = drive.actionBuilder(new Pose2d(53,-43,Math.PI))
                .waitSeconds(1)
                .lineToX(49)
                .strafeToConstantHeading(new Vector2d(49,-60))
                .build();
        trajectoryRightCloseOut = drive.actionBuilder(new Pose2d(53,-48,Math.PI))
                .waitSeconds(1)
                .lineToX(49)
                .strafeToConstantHeading(new Vector2d(49,-60))
                .build();
        ...
        telemetry.addLine("Did not Closed Camera.");
        telemetry.update();
    }
}