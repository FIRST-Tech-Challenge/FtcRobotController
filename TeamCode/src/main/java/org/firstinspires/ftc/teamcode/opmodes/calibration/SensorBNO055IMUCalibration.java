 ...
 */
@TeleOp(name = "Sensor: BNO055 IMU Calibration", group = "Sensors")
@Disabled
public class SensorBNO055IMUCalibration extends LinearOpMode {
    public static final String Calibration_filename = "REV_IMUCalibration.json";
    //----------------------------------------------------------------------------------------------
    // State
    //----------------------------------------------------------------------------------------------
    ...
    @Override public void runOpMode() {
        ...
        telemetry.log().add("");
        telemetry.addData("01 - GYR", "Simply let the sensor sit flat for a few seconds.");
        telemetry.addData("02 - ACC", "Rotate 45 degrees. Wait a few secs, repeat.");
        telemetry.addData("03 - MAG", "Move slowly in a figure 8 pattern in the air, until the calibration values reaches 3.");
        telemetry.addData("04 - SYS", "This will usually reach 3 when the other items have also reached 3. Repeat all steps.");
        telemetry.log().add("");
        ...
        while (opModeIsActive()) {
            ...
            if (gamepad1.a) {
                ...
                File file = AppUtil.getInstance().getSettingsFile(Calibration_filename);
                ReadWriteFile.writeFile(file, calibrationData.serialize());
                telemetry.log().add("saved to '%s'", Calibration_filename);
