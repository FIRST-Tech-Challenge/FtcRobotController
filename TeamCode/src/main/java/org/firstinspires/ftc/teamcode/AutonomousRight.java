...
//      unitTestOdometryDrive();
    ...
    private void moveToTallJunction() {
        ...
        driveToPosition( 53.0, -2.0, -50.0, DRIVE_SPEED_20, TURN_SPEED_20 );
        robot.driveTrainMotorsZero();
    ...
    private void signalZoneParking( int signalZoneLocation ) {
        ...
        if( signalZoneLocation == 1 ) { // RED
            // Turn fully -90 deg
            driveToPosition( 51.0, 0.0, -90.0, DRIVE_SPEED_20, TURN_SPEED_20 );
            robot.driveTrainMotorsZero();
            ...
            driveToPosition( 51.0, -24.0, -90.0, DRIVE_SPEED_20, TURN_SPEED_20 );
            driveToPosition( 51.0, -24.0, 180.0, DRIVE_SPEED_20, TURN_SPEED_20 );
            ...
            driveToPosition( 51.0, 0.0, 0.0, DRIVE_SPEED_20, TURN_SPEED_20 );
            robot.driveTrainMotorsZero();
            // Lower lift to driving height
            robot.liftPosInit( robot.LIFT_ANGLE_COLLECT );
            while( opModeIsActive() && (robot.liftMotorAuto == true) ) {
            ...
            driveToPosition( 51.0, 24.0, 0.0, DRIVE_SPEED_20, TURN_SPEED_20 );
