...
{
    ///////////////////////////////////////////////////////// Class Variables /////////////////////////////////////////////////////////
    private PIDCoefficients pidCoefficients;//contains the factors for Proportional, Integral, and Derivative control
    ...
    private boolean m_continuous = false;	// do the endpoints wrap around? eg. Absolute encoder, or rotation
    ...
    /**
     * Allocate a PID object with the given PIDCoefficients object
     * @param coefficients the PIDCoefficients object that contains all necessary coefficients
     */
    ...
    /**
     * Reset the previous error, total error, the integral term, and disable the controller.
     */
    public void reset()  {
        disable();
        m_prevError = 0;
    ...
    /**
     * Set the input value (aka current value) to be used by the next call to performPID().
    ...
    /**
     * Set the setpoint (aka goal) for the PIDController
