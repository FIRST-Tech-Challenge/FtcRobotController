...
//            float stop_intake = gamepad1.left_trigger;
            ...
            if (slowMode) {
                if (left_stick_x == 0 && left_stick_y == 0 && right_stick_x == 0) {
                    magnitude = 0;
                } else {
                    magnitude = 0.3;
                }
                ...
                magnitude = Math.sqrt(Math.pow(left_stick_x, 2) + Math.sqrt(Math.pow(left_stick_y, 2)) + Math.sqrt(Math.pow(right_stick_x, 2)));
            }
...
//            boolean ring_clamp = gamepad1.y;
//            boolean wobble_goal_servo = gamepad1.x;
//            boolean speed_mode_toggle = gamepad1.a;
//            boolean servo = gamepad2.x;
//            float shooter = gamepad2.right_trigger;
//
//            angleInRadian = Math.atan2(left_stick_y, left_stick_x);
...
//
//            /**Speed Mode**/
//            if (speed_mode_toggle) { //click a to turn on slowmode
//                slowMode = true;
//                if (slowIsOn) {
//                    slowIsOn = false;
//                } else if (slowIsOn == false) {
//                    slowIsOn = true;
//                }
//            }
//            else {
...
//            if (slowMode) {
//                if (slowIsOn) {
//                    telemetry.addData("Slow mode", " true");
//                    telemetry.update();
...
//                    }
//                } else {
//                    telemetry.addData("Slow mode", " false");
//                    telemetry.update();
