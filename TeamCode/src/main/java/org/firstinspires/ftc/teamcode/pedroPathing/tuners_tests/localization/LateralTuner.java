...
public class LateralTuner extends OpMode {
    ...
    public static double DISTANCE = 119;//obs corner to basket with twofish
    ...
    public void loop() {
        ...
        telemetryA.addLine(Double.toString(DISTANCE / (poseUpdater.getPose().getY() / poseUpdater.getLocalizer().getLateralMultiplier())));
        telemetryA.update();
