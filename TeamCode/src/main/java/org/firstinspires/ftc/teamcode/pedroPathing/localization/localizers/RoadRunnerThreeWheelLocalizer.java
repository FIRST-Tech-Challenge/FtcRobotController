...
//    public static double WHEEL_RADIUS = 1.25984; // in
//    public static double GEAR_RATIO = 1; // output (wheel) speed / input (encoder) speed
//
//    public static double X_MULTIPLIER = 0.5008239963;
//    public static double Y_MULTIPLIER = 0.5018874659;
//
//    public static double leftX = -67/25.4 - 0.1, leftY = 200/25.4, rightX = -67/25.4 - 0.1, rightY = -200/25.4, strafeX = 147/25.4+0.25, strafeY = 6/25.4-0.23;
//
...
//        leftEncoder = new RoadRunnerEncoder(hardwareMap.get(DcMotorEx.class, "lefFront")); // left encoder, port 1
//        rightEncoder = new RoadRunnerEncoder(hardwareMap.get(DcMotorEx.class, "rightRear")); // right encoder. port 2
//        strafeEncoder = new RoadRunnerEncoder(hardwareMap.get(DcMotorEx.class, "leftRear")); // strafe encoder, port 3
//
