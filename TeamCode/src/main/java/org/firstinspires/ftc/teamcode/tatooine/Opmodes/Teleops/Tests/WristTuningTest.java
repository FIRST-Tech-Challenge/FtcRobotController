...
public class WristTuningTest extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        while (opModeIsActive()){
            ...
            if (gamepadEx1.justPressedButton(GamepadKeys.Button.RIGHT_BUMPER)){
                pos = MathUtil.wrap(pos + WRIST_SENSITIVITY, 0, 1);
                wrist.setPositionWristAngle(pos);
            }
            else if (gamepadEx1.justPressedButton(GamepadKeys.Button.LEFT_BUMPER)){
                pos = MathUtil.wrap(pos - WRIST_SENSITIVITY, 0, 1);
                wrist.setPositionWristAngle(pos);
            }
