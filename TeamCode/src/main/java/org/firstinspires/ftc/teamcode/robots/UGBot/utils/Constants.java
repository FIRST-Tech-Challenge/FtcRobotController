...
public class Constants {
    ...
    public enum Position {
        ...
        TARGET_B_1((49)/INCHES_PER_METER, 9.5*12/INCHES_PER_METER, 0,270,-1,1), //        TARGET_B_1((49-7)/INCHES_PER_METER, 8.5*12/INCHES_PER_METER, 0,0,5,1),
        TARGET_B_2((49+7)/INCHES_PER_METER, 8*12/INCHES_PER_METER, 0,270,-1,0.02),
        ...
        WOBBLE_TWO_EXIT_B((49+3)/INCHES_PER_METER, (2.5*12)/INCHES_PER_METER, 350, 320,-1, 1),
