...
public class Constants {
    ...
    public enum Position {
        ...
        TARGET_C_2((49+7)/INCHES_PER_METER, 10.5*12/INCHES_PER_METER, 0,45+45,5,1),
        TARGET_B_1((49-7)/INCHES_PER_METER, 8.5*12/INCHES_PER_METER, 0,0,5,1),
        TARGET_B_2((49+7)/INCHES_PER_METER, 8*12/INCHES_PER_METER, 0,0,5,1),
        TARGET_A_1((49+7)/INCHES_PER_METER, 7.75*12/INCHES_PER_METER, 0,180,5,0),
        TARGET_A_2((49-7)/INCHES_PER_METER, 7*12/INCHES_PER_METER, 0,45+45,5,1),
        ...
        WOBBLE_TWO_APPROACH(40/INCHES_PER_METER, (23+6+ ROBOT_RADIUS_INCHES)/INCHES_PER_METER, -1, 0,0, .5),
        WOBBLE_TWO_GRAB (40/INCHES_PER_METER, (23)/INCHES_PER_METER, -1, 0,0,0),
        NAVIGATE(35/INCHES_PER_METER, 6.5*12/INCHES_PER_METER,-1,-1, -1, .5),
