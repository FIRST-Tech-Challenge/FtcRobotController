...
public class DriveConstants {
    ...
    public static PIDFCoefficients MOTOR_VELO_PID = new PIDFCoefficients(35, 0, 8,
    ...
    public static double GEAR_RATIO = 1.046; // output (wheel) speed / input (motor) speed
    public static double TRACK_WIDTH = 10.74; // in
    ...
    public static double MAX_ANG_VEL = Math.toRadians(279.98601117318435);
