...
@Autonomous(name = "Robot: April Tag Auto Blue Right", group = "Robot")
//@Disabled
public class TEST1_BR_Tensor_AprilTag extends LinearOpMode {
...
//            //****************************************************************
        ...
        telemetry.update();
        encoderDrive(0.65, 21.5, 21.5, 21.5, 21.5, 4);//tested with higher speed but then we need to reduce distance
...
//
//        if (DESIRED_TAG_ID<=0){
//            DESIRED_TAG_ID = 3;//if we did not recognize the location using distance sensor assign 5
//            telemetry.addData("NOT FOUND ASSIGN TO ID", DESIRED_TAG_ID);
//            telemetry.update();
//            sleep(1000);
//        }
...
//            sleep(2000);
            ...
            encoderDrive(0.65, 17, 17, 17, 17, 5.0);  // S1: backward 27 Inches with 5 Sec timeout
...
//***************Apriltag code************************************
//            runMotorsWithTurning(0, 0, 115); //rotate counterclockwise 115 degree
//
//            encoderDrive(0.25,12,12,12,12,3);
//            //drive toward backdrop
//            sleep(1000);
//            //**stop here first
//            DrivetoApriltag(DESIRED_TAG_ID);
//*************************************End of Apriltag unfinished
//            encoderDrive(0.25, 2, 2, 2, 2, 2);

            //encoderDrive(0.25, 2, 2, 2, 2, 2.0);

            runMotorsWithTurning(0, 0, 90); //rotate counterclockwise 90 degree

            //drive toward backdrop
            encoderDrive(0.4, 72, 72, 72, 72, 8);
            sleep (1000);
            runMotorsForTime(0,0.3,0,1.0 );
            sleep(1000);
            encoderDrive(0.4, 19, 19, 19, 19, 5);
...
//            if (DESIRED_TAG_ID == 6) {
            ...
            sleep(2000);
            IntakeWheel.setPower(0);
            //*****************go through middle of the gate but it will runover partner's pixel placing
//            encoderDrive(0.25, 72, 72, 72, 72, 8);
//            sleep (1000);
//            runMotorsForTime(0,-0.2,0,0.75);
//            sleep(1000);
//            encoderDrive(0.25, 17, 17, 17, 17, 5);
            //***********************************
...
//            sleep(500);
            ...
            //runMotorsForTime(0,0.3,0,2);//park to the left of the field
...
//*********************************************************************************
            ...
            runMotorsForTime(0,0.25,0,1.1);
            sleep(1000);
            //drive toward backdrop
            encoderDrive(0.6, -72, -72, -72, -72, 6);
            sleep (50);

            runMotorsForTime(0,-0.3,0,2.85);
//            sleep(1000);
            runMotorsWithTurning(0, 0, 90); //rotate clockwise 180 degree
            encoderDrive(0.3, 17, 17, 17, 17, 5);
