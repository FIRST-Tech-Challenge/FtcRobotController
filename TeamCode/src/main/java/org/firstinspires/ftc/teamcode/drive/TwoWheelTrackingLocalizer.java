...
public class TwoWheelTrackingLocalizer extends TwoTrackingWheelLocalizer {
    ...
    public static double PARALLEL_X = 1.57; // X is the up and down direction
    public static double PARALLEL_Y = 6.3; // Y is the strafe direction

    public static double PERPENDICULAR_X = -1.377;
    ...
    public static double Y_MULTIPLIER = 1.0104; // Multiplier in the Y direction
