...
@Autonomous (name = "Blue: Carousel Side Autonomous", group = "Blue")
public class Blue_Carousel extends LinearOpMode {
  ...
  private void strafeCarousel() {
    ...
    while (leftDistance.getDistance(DistanceUnit.INCH) > 12) {
    ...
    */
    ...
    setThrottle(0.5, 0.5, 0.5, 0.5);

    while (carouselDistance.getDistance(DistanceUnit.INCH) > 6) {
