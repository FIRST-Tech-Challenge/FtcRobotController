...
public class PowerPlayAuton extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        int pick = new Random().nextInt(RobotManager.ParkingPosition.values().length);
        RobotManager.ParkingPosition parkingPosition = RobotManager.ParkingPosition.values()[pick];

        telemetry.addData("Parking position", parkingPosition.toString());
