...
public class RRHigh extends DriveMethods{
    public void runOpMode() {
        ...
        driveForDistance(.1, Variables.Direction.FORWARD,0.35,0);
        driveForDistance(0.7, Variables.Direction.RIGHT,0.35,0);
        driveForDistance(1.12, Variables.Direction.FORWARD,0.35,0);
        driveForDistance(0.4, Variables.Direction.LEFT, 0.35,0);
        goToHigh();
        ...
        goToDown();
        sleep(500);
        driveForDistance(0.37, Variables.Direction.RIGHT, 0.35,0);
        driveForDistance(1.22, Variables.Direction.BACKWARD,0.35,0);
        driveForDistance(1.55, Variables.Direction.LEFT,0.35,0);
