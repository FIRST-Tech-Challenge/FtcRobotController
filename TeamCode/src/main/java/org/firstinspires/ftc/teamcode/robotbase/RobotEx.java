...
public class RobotEx {
    ...
    protected final GamepadExEx driverOp;
    protected final GamepadExEx toolOp;
...
//    protected BalancingSubsystem balancer;
    ...
    public RobotEx(HardwareMap hardwareMap, Telemetry telemetry, Gamepad driverOp,
                   Gamepad toolOp) {
    ...
    public RobotEx(HardwareMap hardwareMap, Telemetry telemetry, Gamepad gamepadA,
                   Gamepad gamepadB, Boolean initCamera, Boolean useCameraFollower,
        ...
        ///////////////////////////////////////// Gamepads /////////////////////////////////////////
        this.driverOp = new GamepadExEx(gamepadA);
        this.toolOp = new GamepadExEx(gamepadB);
