...
public class RedLeftPathTest extends LinearOpMode {
  ...
  public void runOpMode() throws InterruptedException {
    ...
    toTruss.add(new EndWaypoint(-40, -59.75, toRadians(180), 0.8, 0.8, 15, 4, toRadians(10)));
    Path toBackdrop = new Path();
    toBackdrop.add(new StartWaypoint(toTruss.get(toTruss.size() - 1).getPose().getTranslation()));
    toBackdrop.add(new GeneralWaypoint(5, -59.75, toRadians(185), 1.0, 0.8, 10));
    ...
    backToTruss.add(new GeneralWaypoint(20, -59.75, toRadians(180), 0.8, 0.8, 5));
    backToTruss.add(new GeneralWaypoint(-35, -59.75, toRadians(180), 1.0, 0.8, 10));
