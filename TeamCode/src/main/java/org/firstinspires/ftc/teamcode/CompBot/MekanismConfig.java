...
public class MekanismConfig {
   ...
   *
   * <p>Starts all the devices and maps where they go, as well as sets direction and whether motors
   * run with encoders or not.
   */
   ...
   * Homes the pivot.
   *
   * <p>Runs the pivot up until either the limit switch is triggered or the program is stopped
   *
   * @see #homeSlide()
   */
   ...
   * Homes the slide.
   *
   * <p>Runs the slide in until either the limit switch is triggered or the program is stopped
   *
   * @see #homePivot()
   */
   ...
   * <p>All in Inches.
   *
   * <p>Max 20IN for both X and Y coordinates.
   *
