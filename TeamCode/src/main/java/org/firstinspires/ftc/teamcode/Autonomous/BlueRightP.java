...
//        int position = robot.BlueElemTest(this,0,0);
        ...
        waitForStart();
        robot.goToPosition(0,-10,0,0,0.5);
        sleep(500);
        robot.TurretSlidesToPosition(-8,12,0,0.5);
...
//        robot.TurretReset(0.5);
        robot.goToPosition(1,-4,-30,-76,0.4);
        robot.goToPosition(1,-6,-32,-76,0.4);
        robot.FlipBasketArmToPosition(0.00);
        robot.FlipBasketToPosition(1.0);
        robot.spinCarouselAutonomousBlue();
        robot.goToPosition(0,-25,-23,2,0.4);
