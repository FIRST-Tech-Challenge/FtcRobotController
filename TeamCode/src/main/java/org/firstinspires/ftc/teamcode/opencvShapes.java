...
public class opencvShapes extends LinearOpMode {
    ...
    private static class ShapeDetectionPipeline extends OpenCvPipeline {
        ...
        private final AtomicReference<ShapeSnapshot> latest = new AtomicReference<>(new ShapeSnapshot(0, 0, 0));
        ...
        public static class ShapeSnapshot {
            ...
            public ShapeSnapshot(int circles, int rects, int hexes) {
        ...
        public Mat processFrame(Mat input) {
            ...
            latest.set(new ShapeSnapshot(circleCount, rectCount, hexCount));
            return input;
        }
