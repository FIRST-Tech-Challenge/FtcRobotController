...
@Autonomous(name = "FINALOPREDLEAGUE")
public class FinalOpBlue extends CommandOpMode {
...
//        sensor = new SensorRevTOFDistance(hardwareMap, "commonSense");
        ...
        Trajectory path1 = drive.trajectoryBuilder(startPose)
                .splineTo(new Vector2d(9, -33), Math.toRadians(135))
                .build();
        Trajectory path2 = drive.trajectoryBuilder(path1.end())
                .back(17.5)
                .build();
        Trajectory path3 = drive.trajectoryBuilder(path2.end())
                .splineToLinearHeading(new Pose2d(44.25, -28.5, Math.toRadians(0)), Math.toRadians(0))
                .build();
        ...
        Trajectory path9 = drive.trajectoryBuilder(startPose)
                .lineToConstantHeading(new Vector2d(29.5, -36))
                .build();
