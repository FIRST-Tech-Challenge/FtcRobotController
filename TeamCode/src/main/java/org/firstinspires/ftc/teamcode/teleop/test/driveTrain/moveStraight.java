...
public class moveStraight extends OpMode{
    ...
    void DriveTrainPowerEncoder(){
        ...
        if (a.getState() == Button.State.TAP){
            ...
            robot.botL.setTargetPosition(posBotL + distanceBot);
            robot.topL.setTargetPosition(posTopL + distanceTop);
            robot.botR.setTargetPosition(posBotR + distanceBot);
            robot.topR.setTargetPosition(posTopR + distanceTop);
