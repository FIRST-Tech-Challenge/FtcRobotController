...
import org.firstinspires.ftc.teamcode.RoadRunner1_0.messages.ThreeDeadWheelInputsMessage;
...
public final class ThreeDeadWheelLocalizer implements Localizer {
    ...
    public ThreeDeadWheelLocalizer(HardwareMap hardwareMap, double inPerTick) {
        ...
        parl = new OverflowEncoder(new RawEncoder(hardwareMap.get(DcMotorEx.class, "riggod")));
        parr = new OverflowEncoder(new RawEncoder(hardwareMap.get(DcMotorEx.class, "hexy")));
        perp = new OverflowEncoder(new RawEncoder(hardwareMap.get(DcMotorEx.class, "slidegod")));
