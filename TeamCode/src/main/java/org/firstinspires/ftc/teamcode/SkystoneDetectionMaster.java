...
public class SkystoneDetectionMaster {
    private OpenCvWebcam webcam;
    private SkystoneDetectionPipeline opencv = null;
    private HardwareMap op;
    public SkystoneDetectionMaster(HardwareMap p_op){
    ...
    public void observeStone(){
        //create the pipeline
        opencv = new SkystoneDetectionPipeline();
