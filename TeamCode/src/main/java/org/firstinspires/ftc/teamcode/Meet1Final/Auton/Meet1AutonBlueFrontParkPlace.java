...
@Autonomous(name = "Meet 1 Auton Blue Front Park Place")
public class Meet1AutonBlueFrontParkPlace extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        if (opModeIsActive()) {
            ...
            int leftFrontDriveNecessaryTicks = calculateTicksForLateralMovement(31); //2000
            int rightFrontDriveNecessaryTicks = calculateTicksForLateralMovement(31);
            int leftBackDriveNecessaryTicks = calculateTicksForLateralMovement(31);
