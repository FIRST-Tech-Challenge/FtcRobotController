...
public class LeftPathTest extends CommandOpMode {
...
//    private Pose2d startPose = new Pose2d(35.0, -62.0, Math.toRadians(0.0));
    ...
    public void initialize() {
        ...
        Trajectory left = drive.trajectoryBuilder(new Pose2d(12.55, -64.31, Math.toRadians(90.00)))
                .lineToConstantHeading(new Vector2d(-17.62, -30.06))
                .build();


        TrajectoryFollowerCommand autonomous = new TrajectoryFollowerCommand(drive, left);
