...
public class BasicPipelineBlue extends OpenCvPipeline {

    Scalar darkestJunctions = new Scalar(87.8, 73.7, 79.3);
    Scalar lightestJunctions = new Scalar(155.8, 213.9, 255);
    Mat rawHSV = new Mat();
