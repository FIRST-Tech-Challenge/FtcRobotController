 ...
 */
public class BareboneFourWheelMecanumDriveTrain extends FourWheelMecanumDrive {
    ...
    public BareboneFourWheelMecanumDriveTrain(HardwareMap hardwareMap, GamepadEx gamepad, Telemetry telemetry, DriverFeedback feedback, LimeLight limeLight) {
