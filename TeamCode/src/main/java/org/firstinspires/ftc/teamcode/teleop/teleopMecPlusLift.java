...
//            float liftDeliverMotorPower = gamepad2.right_trigger;
            boolean intakeMotorButtom = gamepad1.b;
            boolean intakeMotorButtomReverse = gamepad1.x;

            float intakeMotorPower = 1f;

            float lifterRaiseMotorPower = gamepad1.right_trigger;
            float lifterLowerMotorPower = gamepad1.left_trigger;
            ...
            //lifterLower
                ...
                lifterMotor.setPower(0.25 * (lifterRaiseMotorPower));
            //intake
            } else {
