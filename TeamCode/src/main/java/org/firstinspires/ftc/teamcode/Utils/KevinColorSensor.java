...
public class KevinColorSensor extends ColorSensorComposition {
    public ColorSensor colorSensor = null;
    public DistanceSensor distanceSensor = null;
    HardwareMap hardwareMap = null;

   public KevinColorSensor(HardwareMap HwMap){
       hardwareMap = HwMap;
       colorSensor = hardwareMap.get(KevinColorSensor.class, "ColorSensor");
       distanceSensor = (DistanceSensor) hardwareMap.get(KevinColorSensor.class , "DistanceSensor");
