...
public class RevOldIMU extends GyroEx {
     ...
     */
    public RevOldIMU(HardwareMap hw, String imuName) {
     ...
     * @param hw Hardware map
     */
    public RevOldIMU(HardwareMap hw) {
        this(hw, "imu");
    }
    ...
    public double[] getXYZGs() {
        Acceleration accel = revIMU.getLinearAcceleration();
        return new double[]{accel.xAccel, accel.yAccel, accel.zAccel};
    }
