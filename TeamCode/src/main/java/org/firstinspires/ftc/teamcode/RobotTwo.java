...
@TeleOp(name="RobotTwo", group="Competition")
public class RobotTwo extends CommandOpMode {
    ...
    public void initialize() {
        ...
        */
        ...
        if (INTAKE_ENABLED) {
             ...
             */
            MotorEx servoIntakeLeft = new MotorEx(hardwareMap, "servoIntakeLeft");
            MotorEx servoIntakeRight = new MotorEx(hardwareMap, "servoIntakeRight");
        ...
        if (CAROUSEL_ENABLED) {
            ...
            motorCarousel m_carousel = new motorCarousel(motorCarousel, telemetry);
