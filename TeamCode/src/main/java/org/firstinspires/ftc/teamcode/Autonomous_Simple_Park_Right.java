...
@Autonomous(name = "simple park right", group = "Match")
public class Autonomous_Simple_Park_Right extends LinearOpMode {
    public String workingMode = "simple_park_right";
