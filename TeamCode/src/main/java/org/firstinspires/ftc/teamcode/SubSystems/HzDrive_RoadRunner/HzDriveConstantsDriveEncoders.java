 ...
 *
 * Tuned for Hazmat Robot.
 *
 * Fields were tuned by editing through the dashboard (connect to the robot's WiFi network and
 ...
 */
@Config
public class HzDriveConstantsDriveEncoders {
