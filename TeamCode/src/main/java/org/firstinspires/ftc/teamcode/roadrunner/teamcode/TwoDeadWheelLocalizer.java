...
import org.firstinspires.ftc.teamcode.roadrunner.teamcode.messages.TwoDeadWheelInputsMessage;

@Config
public class TwoDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = -881.0525310174768; // y position of the parallel encoder (in tick units)
        public double perpXTicks =    1816.5183751507516; // x position of the perpendicular encoder (in tick units)
    }
    ...
    public TwoDeadWheelLocalizer(HardwareMap hardwareMap, IMU imu, double inPerTick, Pose2d pose) {
        ...
        par = new OverflowEncoder(new RawEncoder(hardwareMap.get(DcMotorEx.class, "backRightMotor")));
