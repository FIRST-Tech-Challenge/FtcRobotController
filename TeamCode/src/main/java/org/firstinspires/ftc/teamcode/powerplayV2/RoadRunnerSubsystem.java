...
//    double dFrontPosition = 24.60;
    ...
    protected Pose2d homePose = new Pose2d(inverted *35 + ErrorX ,-64.015 + ErrorY, Math.toRadians(inverted *90));
    protected Pose2d midPose = new Pose2d(inverted *35, -20, Math.toRadians(inverted * -90));
    protected Pose2d planAMidPose = new Pose2d(inverted * 35, -20, Math.toRadians(inverted *-14.25));
    ...
    protected Pose2d scoringPose = new Pose2d(inverted *24 + 21.80769231, 0 - 5.538461538, Math.toRadians(inverted *-14.25));
    ...
    protected Pose2d parking1 = new Pose2d(inverted *12, -12, Math.toRadians(inverted * -90));
    protected Pose2d parking3 = new Pose2d(inverted *60, -12, Math.toRadians(inverted * 90));
