...
public class Mechanum extends InteractionSurface {
     ...
     */
    public Mechanum(StandardMotor rightTop, StandardMotor rightBottom, StandardMotor leftTop, StandardMotor leftBottom) {
        RIGHT_TOP = rightTop;
