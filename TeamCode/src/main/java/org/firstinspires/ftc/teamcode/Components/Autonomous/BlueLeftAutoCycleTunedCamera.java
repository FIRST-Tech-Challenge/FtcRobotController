...
public class BlueLeftAutoCycleTunedCamera extends LinearOpMode {
    ...
    public static double dropX = 24.25, dropY = 5, dropA = toRadians(40), dropET = toRadians(310);
...
//        robot.cv.observeSleeve();
        TrajectorySequence initialtrajectory = robot.roadrun.trajectorySequenceBuilder(new Pose2d(42, 63.25, toRadians(90)))
                .setTangentOffset(toRadians(180))
                .splineTo(new Vector2d(38, 51), toRadians(260))
                .splineTo(new Vector2d(36, 22), toRadians(270))
                .splineToSplineHeading(new Pose2d(28, 4.4, toRadians(40)), toRadians(230))
                .addTemporalMarker(robot::done)
                .build();
        TrajectorySequence pickupTrajectory = robot.roadrun.trajectorySequenceBuilder(new Pose2d(29.4, 3.2, toRadians(55)))
...
//                    .splineToSplineHeading(new Pose2d(-38,9,toRadians(130)),toRadians(320))
                    .splineToSplineHeading(new Pose2d(dropX-(i+1)*0.1, dropY+(i+1)*0.3, Math.toRadians(50)), Math.toRadians(220))
                    .addTemporalMarker(robot::done)
                    .build());
        }
        TrajectorySequence pickupTrajectory2 = robot.roadrun.trajectorySequenceBuilder(new Pose2d(dropX, dropY, toRadians(65)))
