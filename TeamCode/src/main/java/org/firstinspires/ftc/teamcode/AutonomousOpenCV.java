...
public class AutonomousOpenCV extends LinearOpMode {
     ...
     protected void PushPixelSide(boolean isRight)
    {
        ...
        df.DriveStraight(DRIVE_SPEED, 10, angleTurn, false);
        df.DriveStraight(DRIVE_SPEED, -12, angleTurn, false);
    ...
    private void CrossField()
    {
        ...
        df.DriveStraight(DRIVE_SPEED, isRed ? 48 : -48, 0, true);
        df.DriveStraight(DRIVE_SPEED, 13, 0, false);
    }
    protected void DeliverPixel(int aimingDistance, int strafeCorrection)
    {
        // Strafe 30 inches towards the backboard
        ...
        df.DriveStraight(DRIVE_SPEED, isRed ? 20 + aimingDistance : -6 - aimingDistance, deliveryHeading, false);
