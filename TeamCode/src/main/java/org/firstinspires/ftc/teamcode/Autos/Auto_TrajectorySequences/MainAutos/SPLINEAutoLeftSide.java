...
public class SPLINEAutoLeftSide extends PowerPlay_AprilTagDetectionDeposit {
	...
	public void runOpMode()
	{
		...
		TrajectorySequence junction = bot.trajectorySequenceBuilder(startPose)
				...
				.waitSeconds(0.5)
				.UNSTABLE_addTemporalMarkerOffset(0,()->{
					slideControl.setCustom(1370); // Smacks down into the high junction
				})
				.waitSeconds(.35)
					// DEPOSIT AT HIGH JUNCTION
					.UNSTABLE_addTemporalMarkerOffset(0,()->{
				...
				.waitSeconds(2)
				.UNSTABLE_addTemporalMarkerOffset(0, () ->{
					// idk if this is the right value to raise the slides slightly after moving away from the cone stack slideControl.setCustom(1310);
