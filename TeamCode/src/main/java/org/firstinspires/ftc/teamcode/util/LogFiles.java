...
public final class LogFiles {
    ...
    public static class LogFile {
        ...
        public double mecTransP = AutoMecanumDrive.TRANSLATIONAL_PID.kP;
        public double mecTransI = AutoMecanumDrive.TRANSLATIONAL_PID.kI;
        public double mecTransD = AutoMecanumDrive.TRANSLATIONAL_PID.kD;
        public double mecHeadingP = AutoMecanumDrive.HEADING_PID.kP;
        public double mecHeadingI = AutoMecanumDrive.HEADING_PID.kI;
        public double mecHeadingD = AutoMecanumDrive.HEADING_PID.kD;
        public double mecLateralMultiplier = AutoMecanumDrive.LATERAL_MULTIPLIER;
