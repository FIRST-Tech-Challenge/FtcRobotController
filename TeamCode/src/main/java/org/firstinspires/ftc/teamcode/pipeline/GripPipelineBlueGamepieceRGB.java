...
* @author GRIP
*/
public class GripPipelineBlueGamepieceRGB extends OpenCvPipeline {
	...
	public Mat processFrame(Mat source0)  {
		...
		double[] rgbThresholdRed = {44, 143};
		double[] rgbThresholdGreen = {138, 238};
		double[] rgbThresholdBlue = {139, 255};
