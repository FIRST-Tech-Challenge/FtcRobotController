...
//            shoulderAngleEncoder = hardwareMap.get(DcMotorEx.class, "shoulderAngleEncoder"); //just a REV shaft encoder - no actual motor
    ...
    public void resetCrane(Constants.Position start){
        if(CenterStage_6832.gameState.equals(CenterStage_6832.GameState.AUTONOMOUS) || CenterStage_6832.gameState.equals(CenterStage_6832.GameState.TEST)){
    ...
    public boolean calibrate(){
        ...
        switch (calibrateStage) {
            case 0:
                ...
                robot.driveTrain.articulate(TauDriveTrain.Articulation.lockWheels);
