...
public class HandGrabbingServoLeftLocation extends Location {
    ...
    public HandGrabbingServoLeftLocation(HardwareMap hardware) {
        try {
            SERVO = new StandardServo(hardware, hardware.appContext.getString(R.string.HAND_LEFT_GRABBING_SERVO));
