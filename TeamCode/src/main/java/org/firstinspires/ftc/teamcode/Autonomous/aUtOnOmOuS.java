...
//            if (step == 1) {
//                //drive to buckets
//                if (!(input.getTravelledDistance() >= 14)) {
//                    input.move(-10);
//                }
//                else {
//                    input.move(0);
...
//            if (step == 5) {
//                //turn
//                if (!((imu.getAngle() < -88) && (imu.getAngle() > -92))) {
//                    input.spin(50);
//                }
//                else {
//                    input.spin(0);
...
//            if (step == 6) {
//
//                if (!(input.getTravelledDistance() >= 50)) {
//                    input.move(50);
//                }
//                else {
//                    input.move(0);
...
//            BotTelemetry.addData("Encoder Distance (in inches)", input.getTravelledDistance());
//            BotTelemetry.update();
//        }
