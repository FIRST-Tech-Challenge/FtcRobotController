...
public class SampleTankDrive extends TankDrive {
    ...
    public SampleTankDrive(HardwareMap hardwareMap) {
        ...
        DcMotorEx leftFront = hardwareMap.get(DcMotorEx.class, "frontL");
        DcMotorEx leftRear = hardwareMap.get(DcMotorEx.class, "backL");
        DcMotorEx rightRear = hardwareMap.get(DcMotorEx.class, "backR");
        DcMotorEx rightFront = hardwareMap.get(DcMotorEx.class, "frontR");
