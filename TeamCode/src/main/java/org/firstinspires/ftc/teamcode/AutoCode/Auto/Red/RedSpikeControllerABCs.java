...
public class RedSpikeControllerABCs extends OpenCvPipeline
{
    ...
    Point TopLeftPoint = new Point(140,160); // (0,0) is top left // 47 158
    ...
    Point TopLeftPoint2 = new Point(289,150); // (0,0) is top left
    Point BottomRightPoint2 = new Point(TopLeftPoint2.x + width, TopLeftPoint2.y + hight);

    Point ControlTopLeft = new Point(215,180); // (0,0) is top left // 47 158
    ...
    public void init (Mat input) {
        ...
        CutoutMat3 = Cr.submat(new Rect(ControlTopLeft, ControlBottomRight));
