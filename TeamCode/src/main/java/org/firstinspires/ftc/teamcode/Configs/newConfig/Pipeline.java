...
public class Pipeline extends OpenCvPipeline {
    ...
    public Mat processFrame(Mat input) {
        ...
        if (mat.empty()) {
            location = ShippingElemLocation.NONE;
            return input;
        }
        ...
        if (!left) location = ShippingElemLocation.LEFT;
        else if (!right) location = ShippingElemLocation.RIGHT;
        ...
        else location = ShippingElemLocation.NONE;

        return mat; // return the mat with rectangles drawn
    }


    public ShippingElemLocation getLocation() {
