...
public class BlueCarouselAutonomous extends AutoObjDetectionTemplate {
    ...
    public void opModeMain() throws InterruptedException {
        ...
        if (opModeIsActive() && !isStopRequested()) {
            ...
            driveSystem.moveToPosition(144 - 26, 82.5, 272 - 180, .5, new DistanceTimeoutWarning(500));

            dropOffFreight(Pos);

            driveSystem.moveToPosition(144 - 10, 144, gps.getRot(), 1, new DistanceTimeoutWarning(100));
            //This moves into the wall for duck spinning
            driveSystem.moveToPosition(144 - 0, gps.getY() + 5, gps.getRot(), 1, new DistanceTimeoutWarning(100));
            ...
            if (!overBarrier) {
                ...
                try {
                    driveSystem.moveToPosition(144 - 0, 10, 180, 1, new MovementException[]{new DistanceSensorException(intakeDistanceSensor, 8), new DistanceTimeoutException(500)});
                ...
                driveSystem.moveToPosition(144 - 27, 77, 180, 1, new DistanceTimeoutWarning(500));
