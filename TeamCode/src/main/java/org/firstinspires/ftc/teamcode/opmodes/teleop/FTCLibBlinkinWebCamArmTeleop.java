...
public class FTCLibBlinkinWebCamArmTeleop extends CommandOpMode {
    ...
    public void initialize() {
        ...
        //toolOp2.
        TriggerReader triggerGrabber = new TriggerReader(
                toolOp2, GamepadKeys.Trigger.RIGHT_TRIGGER
        );

        TriggerReader triggerReleaser = new TriggerReader(
                toolOp2, GamepadKeys.Trigger.LEFT_TRIGGER
        );

        //toolOp2.getGamepadButton(GamepadKeys.Trigger).whileActiveContinuous();
