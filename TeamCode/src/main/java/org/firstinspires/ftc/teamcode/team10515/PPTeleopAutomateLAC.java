...
/*
 * This {@code class} acts as the driver-controlled program with Automation for FTC team 10515 for the PowerPlay
...
@TeleOp(name = "PP TeleOp Automate", group = "Main")
@Disabled
public class PPTeleopAutomateLAC extends PPTeleopRobotLAC {
