...
public class Mecanum_Auto_BlueDuck extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        if(opModeIsActive()) {
            ...
            stopMotion(100);
            driveStraight(false, 1.0, 0.4, 1550);

            //driveRightTurn(false, 1.0, 0.5, 650);

            //rotateToAngle(0.0, 1.0, 0.3);

            stopMotion(200);

//        driveStraight(false, 1.0, 0.3, 300);
//        stopMotion(100);
//        rotateToAngle(-90.0,2.0,0.3);
//        stopMotion(200);
//        driveStraight(false, 1.0, 0.3, 1000);
//        stopMotion(100);
//        rotateToAngle(0.0,2.0,0.3);
//        stopMotion(100);
//        driveStraight(false, 1.0, 0.3, 800);
            ...
            if (visionResult == "LEFT") {
                ...
                Slide.setTargetPosition(initialHeight + 1000);
                Slide.setMode(DcMotor.RunMode.RUN_TO_POSITION);
                Slide.setPower(0.8);
            } else if (visionResult == "RIGHT") {
                Slide.setTargetPosition(initialHeight + 1700);
                Slide.setMode(DcMotor.RunMode.RUN_TO_POSITION);
                Slide.setPower(0.8);
            }
