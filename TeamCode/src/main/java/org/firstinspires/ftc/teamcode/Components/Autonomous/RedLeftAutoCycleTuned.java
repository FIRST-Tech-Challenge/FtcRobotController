...
public class RedLeftAutoCycleTuned extends LinearOpMode {
    ...
    public static double dummyx = 24, dummyy = 4, dummya = 270;
    public static double dummyx2 = 24, dummyy2 =11, dummya2 = 270;
    public static double dummyxd = 24, dummyyd = 4.5, dummyad = 270;
    ...
    public void runOpMode() {
        ...
        Trajectory preloadtrajectory2 = robot.roadrun.trajectoryBuilder(startPose)
                .lineToConstantHeading(new Vector2d(38, 10))
                .build();
        Trajectory preloadtrajectory = robot.roadrun.trajectoryBuilder(new Pose2d(38,10, Math.toRadians(270)))
