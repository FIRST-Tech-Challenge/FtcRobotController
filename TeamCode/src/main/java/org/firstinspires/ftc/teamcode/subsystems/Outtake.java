...
public class Outtake implements Subsystem{
    ...
    public double armIntake_Right = 0.51923-0.02; public double armIntake_Left = 0.498335+0.02;
    //private double armTravel_Right = 0.51263; private double armTravel_Left= 0.505265;//0.51263, 0.505265
    private double armTravel_Right = 0.512; private double armTravel_Left= 0.505;//0.51263, 0.505265
    ...
    private double armTravelDown_RightA = 0.50; private double armTravelDown_LeftA= 0.52;//0.51263, 0.505265
    ...
    private double dumpCarryPos = 0.40; //0.6793;
    private double dumpDumpPos = 0.29; //0.24
    ...
    private double dumpDumpPos_auto = 0.35;
    ...
    public void update(TelemetryPacket packet) {
        ...
        if(liftState == 1){
            ...
            if(liftDelayDone(time)){
                ...
                Log.v("StateMach", "lift moving to travelPos, liftState 1 " + (time - liftStartTime));
                tempStartTime = System.currentTimeMillis();
