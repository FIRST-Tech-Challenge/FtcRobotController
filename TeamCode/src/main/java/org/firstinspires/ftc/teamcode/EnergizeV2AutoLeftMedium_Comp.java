...
@Autonomous(name = "Energize V2 Left Medium")
public class EnergizeV2AutoLeftMedium_Comp extends BasicOpMode_Linear {
    OpenCvCamera camera;
    ...
    public void runOpMode() {
        ...
        //4 inch to the nearest line on the left
        //4 inches to the tile split on the left
        //
