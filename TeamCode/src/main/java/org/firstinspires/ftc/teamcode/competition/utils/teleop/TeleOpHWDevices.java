...
public class TeleOpHWDevices {
    ...
    private final boolean SPINNER_MOTOR, SPINNER_SERVO, LIFT_MOTORS, LIFT_SERVO, LIFT_DROPPER, LIFT_SENSOR, DUCK_MOTOR;
     ...
     */
    public TeleOpHWDevices(boolean spinnerMotor, boolean spinnerServo, boolean liftMotors, boolean liftServo, boolean liftDropper, boolean liftSensor, boolean duckMotor) {
