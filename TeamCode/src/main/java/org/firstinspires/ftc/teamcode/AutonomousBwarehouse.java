...
//@Disabled
public class AutonomousBwarehouse extends LinearOpMode {
...
//          telemetry.update();
    ...
    class FreightFrenzyPipeline extends OpenCvPipeline
    {
        ...
        private Point sub1PointA = new Point( 45,190); // 15x15 pixels on LEFT  (limited by barrier!)
        private Point sub1PointB = new Point( 60,205);
