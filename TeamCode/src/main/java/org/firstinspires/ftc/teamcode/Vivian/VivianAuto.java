...
public class VivianAuto extends LinearOpMode {
    ...
    public void proportionalTurn (double degrees){
        ...
        while (opModeIsActive() && Math.abs(error) > 2){
            ...
            telemetry.addData("angle", currentYaw);
            telemetry.addData("motor power", error * P);
    ...
    public void runOpMode () throws InterruptedException {
        ...
        //proportionalMove(12);
        //proportionalMove(-12);
        //encoderMove(12); //move forward 12 inches
        //encoderMove(-12); //move backwards 12 inches
