...
public class PoseFishin {
     ...
     */
    public PoseFishin(double x, double y, double heading, double speed) {
     ...
     */
    public PoseFishin(double x, double y, double angle) {
     ...
     */
    public PoseFishin(RobotType name) {
