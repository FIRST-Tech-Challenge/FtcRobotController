...
public class ThreeDeadWheelLocalizer implements Localizer {
    ...
    public ThreeDeadWheelLocalizer(HardwareMap hardwareMap, double inPerTick) {
        this(hardwareMap, inPerTick, new String[] {"par0", "par1", "perp"});
    }
    ...
    public ThreeDeadWheelLocalizer(HardwareMap hardwareMap, double inPerTick, String[] names){
        ...
        par0 = new OverflowEncoder(new RawEncoder(hardwareMap.get(DcMotorEx.class, names[0])));
        par1 = new OverflowEncoder(new RawEncoder(hardwareMap.get(DcMotorEx.class, names[1])));
        perp = new OverflowEncoder(new RawEncoder(hardwareMap.get(DcMotorEx.class, names[2])));
