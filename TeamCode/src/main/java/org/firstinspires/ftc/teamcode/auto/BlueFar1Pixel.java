...
@Autonomous(name="Blue Far 1Pixel")
public class BlueFar1Pixel extends CommandOpMode {
...
//        Impasta autoImp = new Impasta(fl, fr, bl, br, imu);
        ...
        switch(tagId) {
            case 0:
                prop = UnworkingTrajectories.propFarLeftBlue;
                score = UnworkingTrajectories.scoreFarLeftBlue;
                park = UnworkingTrajectories.parkFarLeftBlue;
                break;
            case 1:
                prop = UnworkingTrajectories.propFarMidBlue;
                score = UnworkingTrajectories.scoreFarMidBlue;
                park = UnworkingTrajectories.parkFarMidBlue;
                break;
            case 2:
                prop = UnworkingTrajectories.propFarRightBlue;
                score = UnworkingTrajectories.scoreFarRightBlue;
                park = UnworkingTrajectories.parkFarRightBlue;
                break;
            default:
                prop = UnworkingTrajectories.propFarLeftBlue;
                score = UnworkingTrajectories.scoreFarLeftBlue;
