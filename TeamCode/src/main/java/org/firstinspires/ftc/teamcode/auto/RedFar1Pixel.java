...
@Autonomous(name="Red Far 1Pixel")
public class RedFar1Pixel extends CommandOpMode {
...
//        Impasta autoImp = new Impasta(fl, fr, bl, br, imu);
        ...
        switch(tagId) {
            case 0:
                prop = UnworkingTrajectories.propFarLeftRed;
                score = UnworkingTrajectories.scoreFarLeftRed;
                park = UnworkingTrajectories.parkFarLeftRed;
                break;
            case 1:
                prop = UnworkingTrajectories.propFarMidRed;
                score = UnworkingTrajectories.scoreFarMidRed;
                park = UnworkingTrajectories.parkFarMidRed;
                break;
            case 2:
                prop = UnworkingTrajectories.propFarRightRed;
                score = UnworkingTrajectories.scoreFarRightRed;
                park = UnworkingTrajectories.parkFarRightRed;
                break;
            default:
                prop = UnworkingTrajectories.propFarLeftRed;
                score = UnworkingTrajectories.scoreFarLeftRed;
