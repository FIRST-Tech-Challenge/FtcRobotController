...
public class OdometryCalibration extends LinearOpMode {
    ...
    String rfName = "rf", rbName = "rb", lfName = "lf", lbName = "lb"; //hardware map motor names
    String verticalLeftEncoderName = rbName, verticalRightEncoderName = lfName, horizontalEncoderName = rfName; //keep the names the same as
                                                                                                                // which motor it is connected to
