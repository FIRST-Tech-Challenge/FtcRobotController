...
public class StateRotateToFieldCenterVelocityControl extends EbotsAutonStateVelConBase{
     ...
     * @param autonOpMode
     */
    public StateRotateToFieldCenterVelocityControl(EbotsAutonOpMode autonOpMode){
        super(autonOpMode);
        ...
        targetHeadingDeg = AllianceSingleton.isBlue() ? -90.0 : 90.0;
