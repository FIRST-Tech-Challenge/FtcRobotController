...
public class SkystoneCam {
    ...
    //This class will contain the code having to do with VuForia
    ...
    public void init(HardwareMap ahwMap){
        ...
        final float CAMERA_FORWARD_DISPLACEMENT  = -0.125f * mmPerInch;   // Camera is .125 Inches behind the robot center
        final float CAMERA_VERTICAL_DISPLACEMENT = 6.875f * mmPerInch;   // eg: Camera is 7 Inches above ground
        final float CAMERA_LEFT_DISPLACEMENT     = -7.3125f;     // eg: Camera is 7.3125 Inches left of the robot's center line
