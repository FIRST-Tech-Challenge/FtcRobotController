...
@Autonomous(name = "Robot: April Tag Auto Red Right", group = "Robot")
//@Disabled
public class TEST1_RR_Tensor_AprilTag extends LinearOpMode {
...
//
//        if (DESIRED_TAG_ID==0){
//            DESIRED_TAG_ID = 5;//if we did not recognize the location using distance sensor assign 5
...
//            sleep(2000);
            ...
            encoderDrive(0.65, 19.5, 19.5, 19.5, 19.5   , 5.0);  // S1: backward 27 Inches with 5 Sec timeout
            ...
            encoderDrive(0.65,20,20,20,20,3);
            //drive toward backdrop
            //sleep(1000);
            //**stop here first April tag
            //DrivetoApriltag(DESIRED_TAG_ID);
            //runMotorsWithTurning(0,0,-90);
//drive toward backdrop

            //sleep(1000);
            runMotorsForTime(0,-0.3,0,2.1);//strafing to right
            //sleep(1000);
            encoderDrive(0.6, 15, 15, 15, 15, 2);
...
//            //sleep(1000);
//            //lower the lift
            //park first move out of the way

            encoderDrive(0.35, -2.3, -2.3, -2.3, -2.3, 2);

            runMotorsForTime(0,-0.3,0,1.5);//park to the right of the field
...
//            if (DESIRED_TAG_ID == 6) {
            ...
            //drop the pixel on backdrop
            //*******************************
            //encoder drive to backdrop
            //runMotorsForTime(0,-0.3,0,1.1);
            //drive toward backdrop
            encoderDrive(0.65, 26, 26, 26, 26, 3);
            //add apriltag stop then forward to drop pixel Maybe with distance sensor

            runMotorsForTime(0,0.3,0,1);
            sleep(50);
            //maybe add strafing to view apriltag
            encoderDrive(0.3, 12, 12, 12, 12, 2);
...
//            servoPlacer.setPosition(0.65 * MAX_POS);
            //sleep(1000);
            //Park first--move out the way
            encoderDrive(0.35, -2.5, -2.5, -2.5, -2.5, 2);
...
//            }
            ...
            //DrivetoApriltag(DESIRED_TAG_ID);
//  ****************************below is encoder drive to April Tag
            runMotorsForTime(0, 0.3, 0, 0.7);

            //drive toward backdrop
            encoderDrive(0.65, 39, 39, 39, 39, 5);
            //runMotorsWithTurning(0, 0, -90); //rotate clockwise 90 degree
            //sleep(1000);
//****************************************
            //drop the pixel on backdrop
...
//            sleep(500);
            //sleep(1000);
            //park first before lower lift --move out the way
