/* Setup the camera
 * Have a string store the label
 * If (string=="car") strafeLeft; straight;
 * If (string=="bike") strafeRight; straight;
 * If (string=="turtle") straight;
 */
                ...
                if (tfod != null) {
                    ...
                    if (updatedRecognitions != null) {
                        ...
                        for (Recognition recognition : updatedRecognitions) {
                            ...
                            if (recognition.getLabel()=="car") detect=1;
                            if (recognition.getLabel()=="turtle") detect=2;
                            if (recognition.getLabel()=="bike") detect=3;
                            telemetry.addData(""," ");
