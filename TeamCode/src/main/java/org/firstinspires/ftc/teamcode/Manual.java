...
public class Manual extends LinearOpMode {
    ...
    private void drive() {
        ...
        // Different combinations so the different wheel angles work together to produce one motion
    ...
    private void moveVerticalSlide() {
        double speed = gamepad2.left_stick_y;

        verticalSlide.setPower(speed);

        telemetry.addData("Vertical slide", "%4.2f", speed);
    }
}
