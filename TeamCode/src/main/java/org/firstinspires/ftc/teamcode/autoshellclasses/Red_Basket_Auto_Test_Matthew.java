...
@Config
@Autonomous(name = "Red_Basket_Auto_Test_Matthew", group = "Autonomous")
public class Red_Basket_Auto_Test_Matthew extends LinearOpMode {
...
//                .build();
        ...
        Actions.runBlocking(
                new SequentialAction(
                        ...
                        _ViperArmActions.DumpInHighBasketTest(),
                        _WristClawActions.WristUp(),
                        driveToPark
