...
public class HzGameField {
    ...
    public static final Pose2d RED_INNER_START_LINE =  new Pose2d(-57,-36,Math.toRadians(-90)); //y=-26
    public static final Pose2d RED_OUTER_START_LINE =  new Pose2d(-57,-54,Math.toRadians(90));
