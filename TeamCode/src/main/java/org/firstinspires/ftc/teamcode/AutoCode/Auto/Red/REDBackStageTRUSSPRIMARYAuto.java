package org.firstinspires.ftc.teamcode.AutoCode.Auto.Red;
...
public class REDBackStageTRUSSPRIMARYAuto extends LinearOpMode {
...
//        LynxModule module;
        ...
        public void runOpMode() throws InterruptedException
        {
            ...
            RedSpikeControllerABCs FrogFinderPipeline = new RedSpikeControllerABCs();
            ...
            trackingWheelIntegrator.setFirstTrackingVal(20,0);
    ...
    public static void clearEnc()        {
        ...
        public void buildTrajectory() {
            ...
            LeftSpike = new StateMTrajectory.Builder()
                    ...
                    .addMovement(new StateMPointApproach.Builder()// sideways
                            .setTargetPosition(27,-5)
                            .setMaxPower(.35) // .4 - 6
                            .setXyGain(.04)
                            .setTargetHeading(0)
                    ...
                    .addMovement(new StateMPointApproach.Builder() //score
                            .setTargetPosition(27,-23)
                            .setMaxPower(.4) // .4 - 6
                            .setXyGain(.04)
                            .setTargetHeading(0)
                            .setHeadingDynamicGain(new AcceleratedGain(.012, -0.0004))
                    ...
                    .addMovement(new StateMPointApproach.Builder()// back
                            .setTargetPosition(25,-15)
                            .setMaxPower(.35) // .4 - 6
                            .setXyGain(.04)
                            .setTargetHeading(0)
                            .setHeadingDynamicGain(new AcceleratedGain(.012, -0.0004))
                    ...
                    .addMovement(new StateMPointApproach.Builder() //med foward
                            .setTargetPosition(15,-50)
                            .setMaxPower(.4) // .4 - 6
                            .setXyGain(.04)
                            .setTargetHeading(0)
                            .setHeadingDynamicGain(new AcceleratedGain(.012, -0.0004))
