...
public class WarehouseSideRedPath2 {
    ...
    public WarehouseSideRedPath2(HardwareMap hwMap, Pose2d sp, Telemetry telemetry){
        this.hwMap = hwMap;
        startPose = sp;
    ...
    public WarehouseSideRedPath2(HardwareMap hwMap, Pose2d sp, FtcDashboard db, Telemetry telemetry){
        this.hwMap = hwMap;
        startPose = sp;
        dashboard = db;
        this.telemetry = telemetry;
    ...
    public void execute(CommandOpMode commandOpMode){
        commandOpMode.schedule(new WaitUntilCommand(commandOpMode::isStarted).andThen(
                stopDetect.andThen(sample1Follower1,sample1Follower2, intakeGroup, sample1Follower4)
        ));
    }
}
