...
public class TeleOpBeta extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        log.info("RoboBeta TeleOp runOpMode() starts (CPU_time = %.2f sec)", getRuntime());
        ...
        log.info("RoboBeta TeleOp finished configuration (CPU_time = %.2f sec)", getRuntime());
        ...
        log.info("RoboBeta TeleOp finished initialization (CPU_time = %.2f sec)", getRuntime());
