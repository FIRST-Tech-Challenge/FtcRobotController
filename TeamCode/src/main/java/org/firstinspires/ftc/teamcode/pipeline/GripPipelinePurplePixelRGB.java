...
/**
* GripPipelinePurplePixelRGB class.
*
* <p>An OpenCV pipeline generated by GRIP.
*
* @author GRIP
*/
public class GripPipelinePurplePixelRGB   extends OpenCvPipeline {
	...
	public Mat processFrame(Mat source0)  {
		...
		double[] rgbThresholdRed = {93.25539313203139, 214.38565446248234};
		double[] rgbThresholdGreen = {55.0359745034211, 198.4300341296928};
		double[] rgbThresholdBlue = {188.0395606910582, 255.0};
