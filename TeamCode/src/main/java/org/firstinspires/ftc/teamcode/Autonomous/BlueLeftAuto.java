        ...
        public void runOpMode() throws InterruptedException {
            ...
            throughTruss[0] =
                    robot
                            ...
                            .waitSeconds(1.0)
                            .lineToLinearHeading(new Pose2d(53, -8, toRadians(181)))
                            .addTemporalMarker(robot::done)
                            .build();
            throughTruss[1] =
                    robot
