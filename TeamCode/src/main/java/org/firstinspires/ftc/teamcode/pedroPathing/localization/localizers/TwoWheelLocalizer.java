...
public class TwoWheelLocalizer extends Localizer { // todo: make two wheel odo work
    ...
    public static double STRAFE_TICKS_TO_INCHES = .002; // 8192 * 1.37795 * 2 * Math.PI * 0.5018874659;
    ...
    public TwoWheelLocalizer(HardwareMap map, Pose setStartPose) {
        ...
        forwardEncoderPose = new Pose(3.511, -3.623, 0);
        strafeEncoderPose = new Pose(3.770, 3.465, Math.toRadians(90));
        ...
        forwardEncoder = new Encoder(hardwareMap.get(DcMotorEx.class, "Front Right"));
        strafeEncoder = new Encoder(hardwareMap.get(DcMotorEx.class, "Back Right"));
