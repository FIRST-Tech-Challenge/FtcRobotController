package org.firstinspires.ftc.teamcode.backend.localisation;
...
public class DeadReckoning {
    ...
    public void move(double x, double y){
        ...
        while (!stopCondition()){
            ...
            /* TODO: Test whether the '-' in front of the 'distance_response' below actually
                     fixes the problem of the dPid_ controller not stopping.

                     Original: m.setPower(distance_response - imu_response)
             */
            for (DcMotor m : L){
