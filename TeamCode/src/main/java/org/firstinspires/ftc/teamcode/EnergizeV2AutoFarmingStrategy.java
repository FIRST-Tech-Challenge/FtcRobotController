...
@Autonomous(name="Energize V2 Auto new", group="Linear Opmode")
public class EnergizeV2AutoFarmingStrategy extends LinearOpMode {
    OpenCvCamera camera;
    ...
    public void runOpMode() {
        ...
        else
        {
           /* if (tagOfInterest.id == 1) {
            ...
            //Large junction Farming Strategy Left
            if (tagOfInterest.id == 1) {
            // close grip on cone
            gripper(close);
            sleep(200);
            ...
            //strafe right half block
            strafeHalfBlock("forward",fast);
            sleep(300);

            //open gripper and score
            gripper(open);
            sleep(300);

            // Move lift down (will change to cone stack height)
            MoveLift(0.0);
            sleep(200);
            ...
            //Move Forward 1 1/2 blocks
            moveWholeBlock("forward", medium);
            moveHalfBlock("forward", medium);
            sleep(300);

            //close grip on cone stack
            gripper(close);
            sleep(300);
            ...
            //strafe left half block
            strafeHalfBlock("backward",fast);
            sleep(300);
            ...
            //park based on tag
            strafeWholeBlock("backward",fast);
            sleep(300);
            moveWholeBlock("forward", medium);
            sleep(300);
        }
            ...
            //Large junction Farming Strategy Right
