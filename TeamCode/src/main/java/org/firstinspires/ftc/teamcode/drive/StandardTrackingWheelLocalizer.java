...
public class StandardTrackingWheelLocalizer extends ThreeTrackingWheelLocalizer {
    ...
    public static double LATERAL_DISTANCE = 10.780583934900001; // in; distance between the left and right wheels
    public static double FORWARD_OFFSET = 6.75; // in; offset of the lateral wheel

    public static double X_MULTIPLIER = 0.9940023453;
    public static double Y_MULTIPLIER = 0.9905416513;
