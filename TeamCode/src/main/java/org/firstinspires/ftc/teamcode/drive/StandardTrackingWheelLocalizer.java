...
//        ));
        frontEncoder = new Encoder(hardwareMap.get(DcMotorEx.class, "front"));//3
        leftEncoder = new Encoder(hardwareMap.get(DcMotorEx.class, "left"));//1
        rightEncoder = new Encoder(hardwareMap.get(DcMotorEx.class, "right"));//2
