...
import org.firstinspires.ftc.teamcode.util.rr.Encoder;
...
public class StandardTrackingWheelLocalizer extends ThreeTrackingWheelLocalizer {
    ...
    public static double X_MULTIPLIER = 1.0067453545; // Multiplier in the X direction
    public static double Y_MULTIPLIER = 1.01234568; // Multiplier in the Y direction
