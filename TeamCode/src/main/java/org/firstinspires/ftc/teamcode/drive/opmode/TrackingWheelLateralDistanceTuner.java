...
public class TrackingWheelLateralDistanceTuner extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        Encoder leftEncoder = new Encoder(hardwareMap.get(DcMotorEx.class, "DriveRR"));
        Encoder frontEncoder = new Encoder(hardwareMap.get(DcMotorEx.class, "DriveLR"));
        Encoder rightEncoder = new Encoder(hardwareMap.get(DcMotorEx.class, "DriveLF"));
        ...
        telemetry.update();
        int leftEncoderPrev  = leftEncoder.getCurrentPosition();
        int rightEncoderPrev = rightEncoder.getCurrentPosition();
        int frontEncoderPrev = frontEncoder.getCurrentPosition();
        ...
        while (!isStopRequested() && !tuningFinished) {
            ...
            telemetry.clearAll();
            int leftEncoderCurrent = leftEncoder.getCurrentPosition();
            int rightEncoderCurrent = rightEncoder.getCurrentPosition();
            int frontEncoderCurrent = frontEncoder.getCurrentPosition();
            ...
            telemetry.addData("Left Encoder: ", leftEncoderCurrent);
            telemetry.addData("Right Encoder: ", rightEncoderCurrent);
            telemetry.addData("Front Encoder", frontEncoderCurrent);
            telemetry.update();
