...
public class AprilTagMapping {
    ...
    static {
        ...
        aprilTags.put(102, new AprilTag("Red Nexus Goal - Field Center - Facing Food Warehouse", 1025, 2920, 3039, 180, new int[0]));
        aprilTags.put(103, new AprilTag("Blue Nexus Goal - Field Center - Facing Food Warehouse", 1025, 4080, 3039, 180, new int[0]));
