...
public class AprilTagMapping {
    ...
    public AprilTag tag100 = new AprilTag();
    public AprilTag tag101 = new AprilTag();
    public AprilTag tag102 = new AprilTag();
    public AprilTag tag103 = new AprilTag();
    public AprilTag tag104 = new AprilTag();
    public AprilTag tag105 = new AprilTag();
    public AprilTag tag106 = new AprilTag();
    public AprilTag tag107 = new AprilTag();

    public static Map<Integer, AprilTag> getMap(){
        return aprilTags;
    }
    public static Map<Integer, AprilTag> aprilTags = new HashMap <Integer, AprilTag>();



    public AprilTagMapping() { //all dimensions are from the center of the apriltag
