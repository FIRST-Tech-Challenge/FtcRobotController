...
public class BlueLeftAutoCycleTuned extends LinearOpMode {
    ...
    public static double dummyx = 24, dummyy = 5, dummya = 270;
    public static double dummyx2 = 24, dummyy2 =11, dummya2 = 270;
    public static double dummyxd = 24, dummyyd = 5.5, dummyad = 270;
    public static double dummyx2i = 24, dummyy2i =11, dummya2i = 270;
    public static double dummyx3i = 24, dummyy3i =9, dummya3i = 270;
    ...
    public static double dummyX3 = 55, dummyY3 = 11, dummyA3 = 0;
    ...
    public void runOpMode() {
        ...
        Trajectory initialtrajectory2 = robot.roadrun.trajectoryBuilder(startPose)
                ...
                .build();
        Trajectory preloadtrajectory2 = robot.roadrun.trajectoryBuilder(new Pose2d(30,57, Math.toRadians(270)))
                .lineToConstantHeading(new Vector2d(30, 10))
                .build();
        Trajectory preloadtrajectory = robot.roadrun.trajectoryBuilder(new Pose2d(30,10, Math.toRadians(270)))
