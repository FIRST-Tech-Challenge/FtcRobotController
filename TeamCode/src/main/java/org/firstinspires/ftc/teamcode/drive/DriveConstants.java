...
public class DriveConstants {
     ...
     * empirically tuned.
     */
//    public static double kV = 0.11707;      //  1.0 / rpmToVelocity(MAX_RPM);
//    public static double kA = 0.00002;      // 0
//    public static double kStatic = 0.0756;  // 0
    ...
    public static double MAX_ACCEL = 60; // in/s/s
