...
public class DriveConstants {
     ...
     */
    public static final double TICKS_PER_REV = 537.6; // feito
    public static final double MAX_RPM = 300; // feito
    ...
    public static PIDFCoefficients MOTOR_VELO_PID = new PIDFCoefficients(0.05, 0, 0,
     ...
     */
    public static double WHEEL_RADIUS = 1.89; // in, feito
    public static double GEAR_RATIO = 1; // output (wheel) speed / input (motor) speed, feito
    public static double TRACK_WIDTH = 15.512; // in, feito
     ...
     */
    public static double MAX_VEL = 61.82; // Feito
