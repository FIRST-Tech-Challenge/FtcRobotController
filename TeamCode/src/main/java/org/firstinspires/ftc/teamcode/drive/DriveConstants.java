...
public class DriveConstants {
     ...
     */
    public static final double TICKS_PER_REV = 537.6; //REV_ENCODER_CLICKS
    ...
    public static double WHEEL_RADIUS = 1.42867741935; // in
    public static double GEAR_RATIO = 1; // output (wheel) speed / input (motor) speed
    public static double TRACK_WIDTH = 13.2435; // in
