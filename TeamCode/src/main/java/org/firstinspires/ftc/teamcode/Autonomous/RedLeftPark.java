...
public class RedLeftPark extends LinearOpMode {
    ...
    public static double
            ...
            x2=-57,y2=-39,h2=-180,v2=0.5,w2=0.1,fR2=5,bf2=2,
    ...
    public void runOpMode() throws InterruptedException {
        ...
        toSpike[0].add(new EndWaypoint(-57, -41, toRadians(-120), 0.6, 0.2, 5, 2, toRadians(5)));
        toSpike[1] = new Path(start);
        toSpike[1].add(new EndWaypoint(-40, 45, toRadians(-91), 0.6, 0, 5, 2, toRadians(10)));
        toSpike[2] = new Path(start);
        toSpike[2].add(new GeneralWaypoint(-40, -50, toRadians(-90),0.5,0.3, 5));
...
////            if(bark==1){
//            preToStack.add(new StartWaypoint(new Translation2d(currentPose.getX()-2, currentPose.getY())));
...
//            if(bark==1){
            ...
            park.add(new EndWaypoint(50,-60,toRadians(-180),0.5,0.3,5,2,toRadians(10)));
//            }
