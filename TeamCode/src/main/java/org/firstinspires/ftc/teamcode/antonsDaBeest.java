...
@Autonomous(name="antonsDaBeestAUOT", group="Auto")
public class antonsDaBeest extends OpMode {
...
//        instructionHandler.addInstruction(
//                1,
//                new SparkFunOTOS.Pose2D(-30,10, 0),
//                armPose.AUTO_2,
//                wristState.UP,
//                clawState.OPENED
//        );
...
//        instructionHandler.addInstruction(
//                2,
//                new SparkFunOTOS.Pose2D(-30,50,0),
//                armPose.AUTO_2,
//                wristState.DOWN,
//                clawState.OPENED
//        );
...
//        instructionHandler.addInstruction(
//                1,
//                new SparkFunOTOS.Pose2D(-41,50,0),
//                armPose.AUTO_2,
//                wristState.DOWN,
//                clawState.OPENED
//        );
...
//        instructionHandler.addInstruction(
//                2.25,
//                new SparkFunOTOS.Pose2D(-41,10,0),
//                armPose.AUTO_2,
//                wristState.DOWN,
//                clawState.OPENED
//        );
...
//        instructionHandler.addInstruction(
//                2,
//                new SparkFunOTOS.Pose2D(-49,10,0),
//                armPose.AUTO_2,
//                wristState.DOWN,
//                clawState.OPENED
//        );
...
//        instructionHandler.addInstruction(
//                2, //was 2
//                new SparkFunOTOS.Pose2D(-30,50,0), //was 40 y
//                armPose.AUTO_3,
//                wristState.DOWN,
//                clawState.OPENED
//        );
//        instructionHandler.addInstruction( //delete when done with park job
//                2, //was 2
//                new SparkFunOTOS.Pose2D(-50,50,0),
//                armPose.AUTO_3,
//                wristState.DOWN,
//                clawState.OPENED
//        );
//        // moves back and turns 180 to pick up from human player
// delete slasehd        instructionHandler.addInstruction(
//                1.7,
//                new SparkFunOTOS.Pose2D(-47,18,180),
//                armPose.AUTO_3,
//                wristState.DOWN,
//                clawState.OPENED
//        );
...
//        instructionHandler.addInstruction(
//                100,
//                new SparkFunOTOS.Pose2D(-50,0,0),
