...
@Autonomous(name="Blue Right Autonomous, Duck Only",group="CompBot")
public class BlueRightAutonDuckOnly extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        while(e.milliseconds() < 6000) {
            r.m.driveRobotCentric(0,-1,0);
        }
        e.reset();
        while(!isStopRequested()) {
            r.m.driveRobotCentric(0,-0.1,0);
        }
