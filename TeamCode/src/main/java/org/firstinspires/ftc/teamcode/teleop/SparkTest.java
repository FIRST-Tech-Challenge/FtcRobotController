...
public class SparkTest extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        //Initialization
        odo = hardwareMap.get(SparkFunOTOS.class, "spark");
        configureOtos();
        telemetry.update();
        waitForStart();
        //Start
        while(!isStopRequested()){
            ...
            telemetry.addData("X coordinate", pos.x * SPARK_DISTANCE_MULTIPLIER);
            telemetry.addData("Y coordinate", pos.y * SPARK_DISTANCE_MULTIPLIER);
