...
public class Datalogger
{
  ...
  private Datalogger(BufferedCsvWriter bufferedCsvWriter, LoggableField[] fields)
  {
     ...
     */
    OpModeNotifications opModeNotifications = new OpModeNotifications();
    ...
    public Datalogger build()
    {
      ...
      try
      {
        BufferedCsvWriter bufferedCsvWriter = new BufferedCsvWriter(
                String.format(Environment.getExternalStorageDirectory().toString() + "/FIRST/Datalogs/%s.txt", filename));
