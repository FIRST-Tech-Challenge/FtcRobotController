...
@TeleOp (name = ("ChaoticMecanumTeleOp"), group = "Iterative OpMode")
public class IterativeMecanumTeleOp extends OpMode{
    ...
    /**getMax()
     *<p>
     * Gets the maximum absolute value from a static array of doubles
