...
import org.firstinspires.ftc.teamcode.team10515.odometery.OdometryGlobalCoordinatePosition;

/**
 * Created by Sarthak on 10/4/2019.
 */
@TeleOp(name = "My Odometry OpMode")
public class MyOdometryOpmode extends ImportantMethods {
    //Drive motors
    ...
    public void goToPosition(double targetXPosition, double targetYPosition, double robotPower, double desiredRobotOrientation, double allowableDistanceError){
        ...
        while(opModeIsActive() && distance > (allowableDistanceError*COUNTS_PER_INCH)){
            ...
            setPosition((int)(robotMovementXComponent + robotMovementYComponent));
            setDesiredAngle(pivotCorrection);
            setPower(robotPower);
        }
