...
@Autonomous(name = "DistanceSensorAutonRight")
public class autonDistanceAttemptRightTest extends CommandOpMode {
...
//                                ),
                                        ...
                                        new WaitCommand(150),
                                        new ParallelCommandGroup(
                                                new InstantCommand(() -> fL.set(0.25)),
                                                new InstantCommand(() -> fR.set(-0.15)),
                                                new InstantCommand(() -> bL.set(-0.15)),
                                                new InstantCommand(() -> bR.set(0.25))
                                        ),
                                        new WaitCommand(1500),
                                        new ParallelCommandGroup(
                                                new InstantCommand(() -> fL.set(-0.3)),
