...
@I2cDeviceType()
@DeviceProperties(name = "FTCPanels", description = "Iron Reign FTC Panels", xmlTag = "FTC_PANELS")
public class FTCPanels extends I2cDeviceSynchDevice<I2cDeviceSynchSimple> {
     ...
     *
     * @param alliance which Alliance to set - RED or BLUE
     */
    public void setAlliance(byte alliance) {
        byte[] data = new byte[1];
        data[0] = (byte) alliance;
        writeI2C(Commands.WRITE_SET_ALLIANCE, data);
    }
    /**
    ...
    private final static I2cAddr ADDRESS_I2C_DEFAULT = I2cAddr.create7bit(0x30);

    public FTCPanels(I2cDeviceSynchSimple deviceClient) {
