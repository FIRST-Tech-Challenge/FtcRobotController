...
public class ContourPipeline320w240hSim extends OpenCvPipeline {
    ...
    public ContourPipeline320w240hSim(Telemetry t) {
    ...
    public Mat processFrame(Mat input) {
        ...
        CAMERA_HEIGHT = input.height();
            ...
            if( getRectMidpointXY().x > 100 &&  getRectMidpointXY().x < 160 ) {
