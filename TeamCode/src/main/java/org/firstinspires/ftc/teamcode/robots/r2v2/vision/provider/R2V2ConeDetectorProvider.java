...
public class R2V2ConeDetectorProvider extends VisionProvider {
    ...
    private R2V2ConeDetectorPipeline pipeline;
    ...
    // Constants
    private static final String TELEMETRY_NAME = "R2D2 Cone Vision Provider";
    ...
    public void initializeVision(HardwareMap hardwareMap) {
        pipeline = new R2V2ConeDetectorPipeline();
    ...
    public void updateVision() {
        ...
        if (timestamp>lastFrameTimestamp){
            ...
            for (Target newCan : frameDetections) {
                ...
                double canDistance = cameraDistance; //from camera //todo tune
                ...
                double targetHeadingRad = Math.toRadians(frameDegrees);
            ...
            //send the targets for field visualization
