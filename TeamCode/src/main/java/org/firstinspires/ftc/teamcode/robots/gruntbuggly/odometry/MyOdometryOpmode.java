 ...
 */
@TeleOp(name = "My Odometry OpMode - Fishin", group = "Test")
public class MyOdometryOpmode extends LinearOpMode {
    ...
    Localizer globalPositionUpdate;
    ...
    public void runOpMode() throws InterruptedException {
        ...
        globalPositionUpdate = new Localizer(verticalLeft, verticalRight, horizontal, COUNTS_PER_INCH, 75);
