...
public class SensorSparkFunOTOS extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        ImuConf otos = Configuration.s_Current.getImu("otos");
        ...
        while (opModeIsActive()) {
            ...
            // heading angle
            SparkFunOTOSCorrected.Pose2D pos = myOtos.getPosition();
    ...
    private void configureOtos() {
        ...
        SparkFunOTOSCorrected.Pose2D offset = new SparkFunOTOSCorrected.Pose2D(0, 0, 0);
        ...
        SparkFunOTOSCorrected.Version hwVersion = new SparkFunOTOSCorrected.Version();
        SparkFunOTOSCorrected.Version fwVersion = new SparkFunOTOSCorrected.Version();
