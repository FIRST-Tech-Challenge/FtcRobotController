    ...
    private void autoSeq() {
        ...
        for (int i = 0; i < NUMLOOPS ; i++)
        {
            ...
            TrajectorySequence seq4 = drive.trajectorySequenceBuilder(drive.getPoseEstimate())
                    ...
                    .lineToLinearHeading(new Pose2d(-11.5, 45, Math.toRadians(180))) //turn to going toward pole
                    .lineToLinearHeading(new Pose2d(-18, 45, Math.toRadians(180))) //driving to pole
                    .build();
            ...
            TrajectorySequence seq5 = drive.trajectorySequenceBuilder(drive.getPoseEstimate())
                    .lineToLinearHeading(new Pose2d(-11.5, 45, Math.toRadians(180))) //back up
                    .build();
