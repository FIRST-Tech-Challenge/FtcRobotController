...
public class Pipeline extends OpenCvPipeline {
    Scalar orange = new Scalar(196, 23, 112);

    // Pink, the default color                         Y      Cr     Cb    (Do not change Y)
    public static Scalar scalarLowerYCrCb = new Scalar(0.0, 200, 50);
    public static Scalar scalarUpperYCrCb = new Scalar(255.0, 255.0, 0);
    ...
    public void ContourPipeline(double borderLeftX, double borderRightX, double borderTopY, double borderBottomY) {
