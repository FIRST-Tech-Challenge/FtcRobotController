...
public class PurePursuitAuto extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        // Add path segments
        controller.addPathSegment(0, 0, 0, 5);
        controller.setPathEndPoint(0,5 );  // Set final destination

        controller1 = new MecanumPurePursuitController(hardwareMap, 0, 5);

         //Add path segments
        controller1.addPathSegment(0, 5, 0, 0); // Example path
