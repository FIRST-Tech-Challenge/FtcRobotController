...
@TeleOp
public class drawLines extends LinearOpMode {
...
//            telemetry.addData("Theoretical max FPS", webcam.getCurrentPipelineMaxFps());
    ...
    class SamplePipeline extends OpenCvPipeline
    {
        ...
        public Mat processFrame(Mat input)
        {
            ...
            Imgproc.line(input, new Point(lineLeftX, 0), new Point(lineLeftX, input.rows()), new Scalar(0, 255, 0), 20);
            //Imgproc.line(input, new Point(lineMiddleX, 0), new Point(lineMiddleX, input.rows()), new Scalar(0, 255, 0), 20);
            Imgproc.line(input, new Point(lineRightX, 0), new Point(lineRightX, input.rows()), new Scalar(0, 255, 0), 20);
