...
public class MaxAngularVeloTuner extends LinearOpMode {
    public static double RUNTIME = 15.0;
    ...
    public void runOpMode() throws InterruptedException {
        ...
        while (!isStopRequested() && timer.seconds() < RUNTIME) {
            ...
            telemetry.addData("In-loop - Max Angular Velocity (rad)", maxAngVelocity);
            telemetry.addData("In-Loop poseVelo.getHeading()", Math.toDegrees(poseVelo.getHeading()));
