...
public class ModuleLeft extends SubsystemBase {
    ...
    public ModuleLeft(HardwareMap hardwareMap, Telemetry telemetry) {
        topModule = hardwareMap.get(DcMotorEx.class, "fl");
        bottomModule = hardwareMap.get(DcMotorEx.class, "bl");
    ...
    public void run(Gamepad gamepad) {
        ...
        telemetry.addData("Left Module Power", topModulePower / magnitude);
        telemetry.addData("Right Module Power", bottomModulePower / magnitude);
        telemetry.update();
    }
