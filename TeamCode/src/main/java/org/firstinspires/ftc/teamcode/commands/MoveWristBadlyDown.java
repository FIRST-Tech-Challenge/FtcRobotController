...
public class MoveWristBadlyDown extends CommandBase {
    ...
    public MoveWristBadlyDown(WristSub wristSubParam, Telemetry telemetry) {
    ...
    @Override
    public void execute() {
        wristSub.setPosition(wristSub.getPosition() - 0.1);
    }
}