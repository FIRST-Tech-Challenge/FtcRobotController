...
public class Arm implements Subsystem {
    ...
    public void periodic() {
        ...
        setMotorFromAngle2();
        setMotorFromAngle1();
        dashboard.addData("desired point:", current_desired_point);
    ...
    public Translation2d anglesToPoint(double firstAngle, double second) {
        ...
        public BTCommand armMoveToPoint(Translation2d point) {
            ...
            public BTCommand armMoveToAngle(double angle1, double angle2) {
                return new RunCommand(
                        ()-> {
                            arm1.set(angleToVoltageA1(angle1));
                            arm2.set(angleToVoltageA2(angle2
                            ));
                        }
