...
public class AutoRConstants {
    ...
    public static Pose2d STACK_POSE = new Pose2d(62.75, -15, toRad(0));
    ...
    public static Pose2dSpline PARK_R_SECOND = new Pose2dSpline(new Pose2d(8, -14, toRad(0)), toRad(135));
