...
//            robot.moveWobbleGoalToPosition(WobbleGoal.Position.RUN);
            ...
            robot.goToPosition(-118.5,-3,90,1);
            robot.startIntake();
            robot.startTransfer();
            robot.goToPosition(-117.5,46,90,0.5);
...
//            robot.moveWobbleGoalToPosition(WobbleGoal.Position.GRAB);
            ...
            sleep(30);
            robot.setVelocity(1650,1000);
            robot.goToPosition(-56,4,2.5,1);
            robot.shootHighGoal(3);
            sleep(75);
            robot.startIntake();
            robot.startTransfer();
            robot.goToPosition(-50,4,2,0.9);
            robot.reverseTransfer();
            sleep(50);
            robot.startTransfer();
            sleep(75);
            ...
            sleep(75);
            robot.goToPosition(-29,4,0,0.65);
            robot.stopIntake();
            sleep(75);
            robot.reverseTransfer();
            sleep(50);
            ...
            robot.goToPosition(-30,9,180,1);
            robot.turnInPlace(180,0.7);
            robot.goToPosition(-21.5,8.5,178,0.9);
            sleep(10);
            robot.closeWobbleGoalClaw();
            sleep(200);
            robot.moveWobbleGoalToPosition(WobbleGoal.Position.RAISE);
