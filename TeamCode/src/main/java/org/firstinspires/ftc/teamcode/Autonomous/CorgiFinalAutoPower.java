...
//        robot.moveWobbleGoalToPosition(WobbleGoal.Position.RUN);
        ...
        telemetry.update();
        if(rings!=1&&rings!=4) {
            robot.goToPosition(-56,-13,0,0.95);
...
//            robot.moveWobbleGoalToPosition(WobbleGoal.Position.RUN);
            ...
            robot.goToPosition(-23,17,150,1);
            robot.closeWobbleGoalClaw();
            sleep(200);
            robot.moveWobbleGoalToPosition(WobbleGoal.Position.RAISE);
            robot.goToPosition(-75,-1,90,1);
            robot.moveWobbleGoalToPosition(WobbleGoal.Position.GRAB);
            sleep(300);
            robot.openWobbleGoalClaw();
            sleep(500);
...
//            sleep(75);
            ...
            robot.stopTransfer();
            sleep(150);
            robot.goToPosition(-107,-16,0,0.6);
            sleep(2000);
//            robot.moveWobbleGoalToPosition(WobbleGoal.Position.DROP);
            sleep(50);
            robot.openWobbleGoalClaw();
            robot.goToPosition(-102,-16,0,0.7);
//            robot.moveWobbleGoalToPosition(WobbleGoal.Position.RUN);
            robot.goToPosition(-54,24.5,0,1);
            robot.shootThreePowerShot();
            sleep(50);
