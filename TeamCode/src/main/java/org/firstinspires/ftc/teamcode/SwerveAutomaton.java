...
public class SwerveAutomaton extends LinearOpMode{
        ...
        public void runOpMode() {
            ...
            while (opModeIsActive()) {
                ...
                // In this mode the Left stick Y moves the robot fwd and back, the X stick turns left and right.
                ...
                if(Math.abs(turn) > 1) {robot.driveRobot(turn);} else {robot.driveRobot(drive);}
