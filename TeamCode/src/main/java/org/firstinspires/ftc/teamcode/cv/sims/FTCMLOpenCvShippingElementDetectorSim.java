...
public class FTCMLOpenCvShippingElementDetectorSim extends OpenCvPipeline {
    ...
    public FTCMLOpenCvShippingElementDetectorSim(Telemetry telemetry) {
        ...
        cvDNN = new Dnn();
        net = Dnn.readNetFromONNX("/Users/alex/FtcRobotController/TeamCode/src/main/assets/tf_models/tflite_models/freight_frenzy_barcodes/ftc_ml_tse_g_o/onxx/ftc_ml_tse_g_o_20220124_234629.onnx");
