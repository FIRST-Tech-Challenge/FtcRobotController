    ...
    @Override public void runOpMode()
    {
        ...
        while (opModeIsActive())
        {
            ...
            if (targetFound) {
                ...
                telemetry.addData("Target name:", " %s", targetName);
                telemetry.addData("Distance:",  "%5.1f inches", targetRange);
                telemetry.addData("Desired heading:","%3.0f degrees", targetBearing);
            } else {
