...
public class DriveConstants {
     ...
     * inches.
     */
    public static double MAX_VEL = 35; //35
    public static double MAX_ACCEL = 25; //25
    public static double MAX_ANG_VEL = 5.578780276476597;
