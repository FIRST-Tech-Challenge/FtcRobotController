...
public class FConstants {
    static {
        ...
        FollowerConstants.mass = 16.96435;

        FollowerConstants.xMovement = 55;
        FollowerConstants.yMovement = 35;

        FollowerConstants.forwardZeroPowerAcceleration = -30;
        FollowerConstants.lateralZeroPowerAcceleration = -101.02161238589814;

        FollowerConstants.translationalPIDFCoefficients.setCoefficients(.051,0,0.01,0);
        FollowerConstants.useSecondaryTranslationalPID = false;
        FollowerConstants.secondaryTranslationalPIDFCoefficients.setCoefficients(0.1,0,0.01,0); // Not being used, @see useSecondaryTranslationalPID

        FollowerConstants.headingPIDFCoefficients.setCoefficients(1.7,0,0.1,0);
