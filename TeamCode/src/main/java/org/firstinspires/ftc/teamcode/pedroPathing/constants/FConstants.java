...
public class FConstants {
    static {
        ...
        */
        ...
        FollowerConstants.zeroPowerAccelerationMultiplier = 4; // NOTE: may also increase this value to 5
        FollowerConstants.centripetalScaling = 0.0005;

        FollowerConstants.pathEndTimeoutConstraint = 50;
        FollowerConstants.pathEndTValueConstraint = 0.995; // NOTE: try this value later 0.985
