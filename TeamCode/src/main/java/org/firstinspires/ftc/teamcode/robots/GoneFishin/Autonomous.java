...
public class Autonomous {
    ...
    public Autonomous(PoseFishin robot, Telemetry telemetry, Gamepad gamepad1) {
        this.robot = robot;
...
//
            ...
            // retrieve stone
            .addSingleState(() -> robot.articulate(PoseFishin.Articulation.retrieveStone))
            .addTimedState(1f, () -> telemetry.addData("DELAY", "STARTED"), () -> telemetry.addData("DELAY", "DONE"))
            ...
            .addTimedState(1f, () -> telemetry.addData("DELAY", "STARTED"), () -> telemetry.addData("DELAY", "DONE"))
            .addSingleState(() -> robot.articulate(PoseFishin.Articulation.retractFromTower))
    ...
    public StateMachine autoMethodTesterTool = getStateMachine(autoStage) // I do actually use this, do not delete
            .addSingleState(() -> robot.articulate(PoseFishin.Articulation.autoRotateToFaceStone))
            .build();
