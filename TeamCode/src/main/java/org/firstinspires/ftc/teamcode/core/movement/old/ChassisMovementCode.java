...
public class ChassisMovementCode { //PATRICK IS RACIST AAA DONT LET HIM SEE THIS!!!!
    public static class Chassis {
        ...
        public void SetAxisMovement() {
            rightEncoder = back_right_wheel.getCurrentPosition() / 360.0 * 1.173150521 - clearRight;
            leftEncoder = -front_right_wheel.getCurrentPosition() / 360.0 * 1.178221633 - clearLeft;
            backEncoder = front_left_wheel.getCurrentPosition() / 360.0 * 1.17584979 - clearBack;
