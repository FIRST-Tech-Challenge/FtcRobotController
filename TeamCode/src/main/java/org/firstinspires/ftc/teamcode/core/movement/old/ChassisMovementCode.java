...
public class ChassisMovementCode { //PATRICK IS RACIST AAA DONT LET HIM SEE THIS!!!!
    public static class Chassis {
        ...
        public double clearRight = 0;
        public double clearLeft = 0;
        public double clearBack = 0;
        public double clearRotate = 0;
        public double fieldLength = 141;
        public double robotLength = 17.25;
        public double robotWidth = 17.375;
        public double countsPerRotation = 360;
        public double trueDrive;

        public double trueStrafe;
        public double slowIntensity = 10;
        ...
        public double oldZAngel =0;
        public double newZAngle = 0;
        ...
        public double IMUDrive = 0;
        public double IMUStrafe = 0;
        ...
        public double strafeSpeedMultiplier = 1;
        int isStrafe = 0;
