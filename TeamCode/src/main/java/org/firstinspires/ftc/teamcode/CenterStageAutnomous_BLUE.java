    ...
    public void runOpMode() {
        ...
        schedule(
                new SequentialCommandGroup(
                        ...
                        autonomousCommands.scoring_randomization(),
                        new InstantCommand(() -> RR_Blue.runBackdrop_Station_First_Cycle(), RR_Blue),
                        autonomousCommands.stackStationIntake(5),
                        new InstantCommand(() -> RR_Blue.runStation_Backdrop_First_Cycle(), RR_Blue),
                        autonomousCommands.elevator(),
                        autonomousCommands.scoring(),
                        new InstantCommand(() -> RR_Blue.runBackdrop_Station_Second_Cycle(), RR_Blue),
                        autonomousCommands.stackStationIntake(3),
                        new InstantCommand(() -> RR_Blue.runStation_Backdrop_Second_Cycle(), RR_Blue),
                        autonomousCommands.elevator(),
                        autonomousCommands.scoring(),
