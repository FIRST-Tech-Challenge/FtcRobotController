...
public class SparkFunOTOS extends I2cDeviceSynchDevice<I2cDeviceSynch> {
    ...
    public double getAngularScalar() {
        ...
        // Convert to double, multiples of 0.1%
        return (deviceClient.read8(REG_SCALAR_ANGULAR) * 0.001) + 1.0;
    }
    ...
    public boolean setAngularScalar(double scalar) {
        ...
        // Write the scalar to the device
        deviceClient.write8(REG_SCALAR_ANGULAR, (byte)((scalar - 1.0) * 1000 + 0.5));
