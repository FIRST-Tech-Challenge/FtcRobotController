package org.firstinspires.ftc.teamcode.robots.gruntbuggly.odometry;
...
public class Localizer implements Runnable{
     ...
     */
    public Localizer(DcMotor verticalEncoderLeft, DcMotor verticalEncoderRight, DcMotor horizontalEncoder, double COUNTS_PER_INCH, int threadSleepDelay){
    ...
    private void LocalizerUpdate(){
        ...
        n = 0; //we actually don't have a center/cross encoder on our diff steer 2 wheel robot
