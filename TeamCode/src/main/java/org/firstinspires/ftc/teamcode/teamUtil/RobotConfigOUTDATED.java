...
//
//            default:
//                throw new IllegalStateException("Unexpected value: " + subsystem);
//        }
...
//        //Remember to adjust i1
//
//        Telemetry.Item currentSubsystem = null;
//        currentSubsystem = telemetry.addData("initialising", "");
//        StringBuilder initialisedSystems = new StringBuilder();
//        Telemetry.Item initialisedSubsystems = null;
//        initialisedSubsystems = telemetry.addData("initialised", initialisedSystems);
//
