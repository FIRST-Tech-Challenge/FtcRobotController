...
//        spikeToBackdrop[0].add(
//                new EndWaypoint(46, -28, toRadians(-179), .6, .1, 3, 3, toRadians(10)));
//      }
//      if (bark == 1) {
...
//            new StartWaypoint(new Translation2d(currentPose.getX()+1, currentPose.getY())));
//        spikeToBackdrop[1].add(
//            new EndWaypoint(46, -36, toRadians(-179), .55, 0.2, 5, 3, toRadians(5)));
//      }
//
//      if (bark ==2){
...
//                new StartWaypoint(new Translation2d(currentPose.getX()+1, currentPose.getY())));
//        spikeToBackdrop[2].add(
//                new EndWaypoint(46, -42, toRadians(-179), .55, 0.2, 3, 3, toRadians(5)));
//      }
