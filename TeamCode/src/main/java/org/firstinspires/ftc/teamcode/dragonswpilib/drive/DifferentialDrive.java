...
public class DifferentialDrive extends RobotDriveBase {
  ...
  public void arcadeDrive(double xSpeed, double zRotation, boolean squareInputs) {
    ...
    DifferentialDrive.WheelSpeeds speeds = arcadeDriveIK(xSpeed, zRotation, squareInputs);

    m_leftMotor.setPower(speeds.left);
    m_rightMotor.setPower(speeds.right);
  }
  ...
  public void curvatureDrive(double xSpeed, double zRotation, boolean allowTurnInPlace) {
    ...
    DifferentialDrive.WheelSpeeds speeds = curvatureDriveIK(xSpeed, zRotation, allowTurnInPlace);
  ...
  public void tankDrive(double leftSpeed, double rightSpeed, boolean squareInputs) {
    ...
    DifferentialDrive.WheelSpeeds speeds = tankDriveIK(leftSpeed, rightSpeed, squareInputs);
  ...
  public void stopMotor() {
    m_leftMotor.setPower(0);
    m_rightMotor.setPower(0);
  }
