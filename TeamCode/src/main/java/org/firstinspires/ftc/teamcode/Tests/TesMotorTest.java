...
public class TesMotorTest extends RFMotorTest {
    public static double max = 1000, min =0 , RESISTANCE = 0, kS = 0.04,kV =  3.2786E-4,kA= 6E-5,
            MAX_UP_VELO= 3000, MAX_DOWN_VELO=-2280,MAX_ACCEL =  10000, MAX_DECEL = -66974,kP= 0,kD= 0;
    public void runOpMode() throws InterruptedException {
        initialize("leftLiftMotor", "rightLiftMotor",(int)max,(int)min, DcMotorSimple.Direction.FORWARD, false);
        waitForStart();
