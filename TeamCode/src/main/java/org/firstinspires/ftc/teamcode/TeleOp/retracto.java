...
@TeleOp(name="retracto")
public class retracto extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        while (opModeIsActive())
        {
            ...
            boolean retractButton = gamepad2.x;
            boolean extendButton = gamepad2.y;

            input.Move(move);
            input.Spin(spin);
            input.Strafe(strafe);
            input.Arm(arm);
            input.retract(retractButton);
