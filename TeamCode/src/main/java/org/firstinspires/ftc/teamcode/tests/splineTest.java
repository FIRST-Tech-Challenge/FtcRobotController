...
//        double desiredVelocityX = trajSequence.getVelocityAtTime(trajSequence, trajTimer.seconds()).getV();
////        double desiredVelocityY = trajSequence.getVelocityAtTime(trajSequence, trajTimer.seconds()).getY();
