...
public class HzDrive_Template extends SampleMecanumDrive_DriveEncoder {
    public boolean FtcDashboard_FLAG = true;

    //double DriveConstants_kV = DriveConstantsDeadWheelEncoder.kV;
    double DriveConstants_kV = DriveConstants_DriveEncoder.kV;

    //double DriveConstants_TRACK_WIDTH = DriveConstantsDeadWheelEncoder.TRACK_WIDTH;
    double DriveConstants_TRACK_WIDTH = DriveConstants_DriveEncoder.TRACK_WIDTH;
    ...
    public HzDrive_Template(HardwareMap hardwareMap) {
        super(hardwareMap);
