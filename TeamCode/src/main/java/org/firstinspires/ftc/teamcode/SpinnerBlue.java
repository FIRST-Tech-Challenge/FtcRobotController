...
import java.util.Locale;
    ...
    @Autonomous(name="SpinnerBlue", group="Autonomous")
//@Disabled
    public class SpinnerBlue extends LinearOpMode {
        ...
        private DcMotor duckspinnerR = null; // the other duck spinner thingy
        ...
        public void runOpMode() {
            ...
            while (opModeIsActive() && (runtime.seconds() < 30.0)) {
                ...
                sleep(250); // Turn left 45 towards goal, and away from spinner
