...
import org.firstinspires.ftc.teamcode.opmodes.autonomous.paths.vuforia.DuckSideBluePath1;
import org.firstinspires.ftc.teamcode.opmodes.autonomous.paths.vuforia.DuckSideBluePath3;
import org.firstinspires.ftc.teamcode.opmodes.autonomous.paths.vuforia.DuckSideRedPath1;
import org.firstinspires.ftc.teamcode.opmodes.autonomous.paths.vuforia.DuckSideRedPath3;
import org.firstinspires.ftc.teamcode.opmodes.autonomous.paths.vuforia.WarehouseSideBluePath1;
import org.firstinspires.ftc.teamcode.opmodes.autonomous.paths.vuforia.WarehouseSideRedPath1;
import org.firstinspires.ftc.teamcode.opmodes.createmechanism.CreateLEDs;


@Autonomous(name="Vuforia Auto Freight Frenzy", group="FreightFrenzy")
public class AutonomousVuforiaFreightFrenzy extends CommandOpMode {
    ...
    public void initialize() {
        ...
        path1Selector.whenPressed(()->{
            ...
            if(Alliance.getInstance().getAllianceTeam() == Alliance.AllianceTeam.BLUE && selectedSide[0] == DUCK_SIDE){
                DuckSideBluePath1 duckSideBluePath1 = new DuckSideBluePath1(hardwareMap, selectedStartPos[0],telemetry);
                ...
                DuckSideRedPath1 duckSideRedPath1 = new DuckSideRedPath1(hardwareMap,selectedStartPos[0],telemetry);
                ...
                WarehouseSideBluePath1 warehouseSideBluePath1 = new WarehouseSideBluePath1(hardwareMap,selectedStartPos[0],telemetry);
                ...
                WarehouseSideRedPath1 warehouseSideRedPath1 = new WarehouseSideRedPath1(hardwareMap,selectedStartPos[0],telemetry);
        ...
        path3Selector.whenPressed(()->{
            ...
            telemetry.update();
            if(Alliance.getInstance().getAllianceTeam() == Alliance.AllianceTeam.BLUE && selectedSide[0] == DUCK_SIDE){
                DuckSideBluePath3 duckSidBluePath3 = new DuckSideBluePath3(hardwareMap,selectedStartPos[0],telemetry);
                duckSidBluePath3.createPath();
                duckSidBluePath3.execute(this);

            }
            else if(Alliance.getInstance().getAllianceTeam() == Alliance.AllianceTeam.RED && selectedSide[0] == DUCK_SIDE){
                DuckSideRedPath3 duckSideRedPath3 = new DuckSideRedPath3(hardwareMap,selectedStartPos[0],telemetry);
