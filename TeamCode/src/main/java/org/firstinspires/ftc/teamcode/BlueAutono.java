...
@Autonomous(name = "BlueAutono")
public class BlueAutono extends LinearOpMode {
    ...
    OpenCvWebcam webcam;
    BarcodeDeterminationBlue.BarcodeDeterminationPipeline pipeline;
    BarcodeDeterminationBlue.BarcodeDeterminationPipeline.BarcodePosition snapshotAnalysis
            = BarcodeDeterminationBlue.BarcodeDeterminationPipeline.BarcodePosition.LEFT; // default
    ...
    public void runOpMode() {
        ...
        pipeline = new BarcodeDeterminationBlue.BarcodeDeterminationPipeline();
    ...
    private void MainCycle()
    {
        ...
        hdw.grabberclaw.setPosition(1.0);
        sleep(500);
        DriveReverseTurret(-0.34, -200, 500, 0.8, 1900, 1.0, 1250, 0.65);
        ResetEncoder();
        main = false;
    ...
    private void FirstCycle()
    {
        ...
        switch (snapshotAnalysis)
        {
            case LEFT:
            {
                ...
                FirstMove(500, 1.0, 2200, 1.0, -800, 1.0);
                break;
            }
            ...
            case RIGHT:
            {
                ...
                FirstMove(500, 1.0, 2500, 1.0, 125, 1.0);
                break;
            }
            ...
            case CENTER:
            {
                ...
                FirstMove(500, 1.0, 2300, 1.0, -425, 1.0);
                break;
            }
        }
        hdw.grabberclaw.setPosition(0.85);
                           ...
                           int VerticalTarget, double VerticalSpeed)
    {
        ...
        hdw.Vertical.setMode(DcMotor.RunMode.RUN_TO_POSITION);
        hdw.Vertical.setPower(VerticalSpeed);
        hdw.wheelFrontRight.setPower(driveSpeed*1.2);
        hdw.wheelBackRight.setPower(driveSpeed);
        hdw.wheelFrontLeft.setPower(driveSpeed);
        hdw.wheelBackLeft.setPower(driveSpeed*1.2); 
                           ...
                           int VerticalTarget, double VerticalSpeed)
    {
        ...
        hdw.wheelFrontLeft.setMode(DcMotor.RunMode.RUN_WITHOUT_ENCODER);
        hdw.wheelFrontRight.setPower(driveSpeed);
        hdw.wheelBackRight.setPower(driveSpeed*1.3);
        hdw.wheelFrontLeft.setPower(driveSpeed*1.3);
        hdw.wheelBackLeft.setPower(driveSpeed);
        hdw.Vertical.setTargetPosition(VerticalTarget);
        hdw.Vertical.setMode(DcMotor.RunMode.RUN_TO_POSITION);
        hdw.Vertical.setPower(VerticalSpeed);
