...
public class TurnTuner extends OpMode {
    ...
    public static double ANGLE = 5 * 2 * Math.PI;
    ...
    public void loop() {
        ...
        telemetryA.addLine(Double.toString(ANGLE / (poseUpdater.getTotalHeading() / poseUpdater.getLocalizer().getTurningMultiplier())));
