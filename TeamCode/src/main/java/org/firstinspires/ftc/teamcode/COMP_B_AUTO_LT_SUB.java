...
public class COMP_B_AUTO_LT_SUB extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        ElapsedTime timer2 = new ElapsedTime();
           ...
           while (armMotor.isBusy() && opModeIsActive()) {
            ...
            intake.setPower(INTAKE_OFF);
            sleep(1000);
            movement("backward",0.2,-10,10);
            movement("rLeft", 0.4, 83, 10);
            movement("forward", 0.4, 30, 10);
            
            movement("stRight",0.4,29,10);
