...
public class DriveConstants {
     ...
     */
    public static double WHEEL_RADIUS = 2.0472441; // 1.88976; // in
    public static double GEAR_RATIO = 1; // output (wheel) speed / input (motor) speed
    public static double TRACK_WIDTH = 15.62; // 15.65; // 15.6; //15.75; // 15.375; // 16.34; // in
    ...
    public static double MAX_ANG_VEL = Math.toRadians(245.04366847983556);
