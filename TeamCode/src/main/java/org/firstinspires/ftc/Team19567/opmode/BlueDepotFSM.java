...
public class BlueDepotFSM extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        chassis.setPoseEstimate(new Pose2d(-43, 64.5, Math.toRadians(-90))); //Set Roadrunner's pose estimate of the robot to the starting position.
        ...
        switch(location) {
            ...
            //Technically first level, although the third level (or no level) is being detected
            case NO_ALLIANCE:
            case ALLIANCE_THIRD: {
        ...
        TrajectorySequence preloadSequence = chassis.trajectorySequenceBuilder(new Pose2d(-42.5, 64, Math.toRadians(-90))) //Sets initial pose, which is equal to the robot's pose estimate, *this is important*
