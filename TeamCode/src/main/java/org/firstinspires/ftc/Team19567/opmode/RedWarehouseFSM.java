...
/**
 * This is the class for the red warehouse side. <br>
 * It utilizes a finite state machine (FSM), just like the other opmodes. <br>
 * Alignment: <a href="https://discord.com/channels/873012716757995540/912908534071558144/946193361600131142">Discord</a>
 */
...
public class RedWarehouseFSM extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        TrajectorySequence firstHubSplineSequence = chassis.trajectorySequenceBuilder(new Pose2d(59.5, -68,0))
                .addTemporalMarker(Utility_Constants.INTAKE_TIME,() -> {
                ...
                .strafeTo(new Vector2d(12,-68.5)).lineToSplineHeading(new Pose2d(0.5,-40,Math.toRadians(-45)))
                .build();
        ...
        switch(location) {
            //Technically second level, although the first level is being detected
            case ALLIANCE_FIRST: {
            ...
            //Technically first level, (due to webcam positioning and some positions sometimes being flipped), although the second level is being detected
            ...
            //Technically third level, although the third level (or no level) is being detected
            case ALLIANCE_THIRD:
            case NO_ALLIANCE: {
