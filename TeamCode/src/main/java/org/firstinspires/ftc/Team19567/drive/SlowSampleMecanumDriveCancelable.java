...
import org.firstinspires.ftc.Team19567.trajectorysequence.TrajectorySequenceRunnerCancelable;
 ...
 */
@Config
public class SlowSampleMecanumDriveCancelable extends MecanumDrive {
    ...
    private static final TrajectoryVelocityConstraint VEL_CONSTRAINT = getVelocityConstraint(MAX_VEL/1.35, MAX_ANG_VEL, TRACK_WIDTH);
    ...
    public SlowSampleMecanumDriveCancelable(HardwareMap hardwareMap) {
        super(kV, kA, kStatic, TRACK_WIDTH, TRACK_WIDTH, LATERAL_MULTIPLIER);

        follower = new HolonomicPIDVAFollower(TRANSLATIONAL_PID, TRANSLATIONAL_PID, HEADING_PID,
                new Pose2d(0.0, 0.0, Math.toRadians(0.0)), 0.5);
