...
import org.nknsd.teamcode.programs.teleops.CollyMovementNKNProgram;

import java.util.concurrent.TimeUnit;

@TeleOp(name = "Collyien Physics")
public class NKNOpMode_Colly extends OpMode {
    ...
    private final NKNProgram program = new CollyMovementNKNProgram();
