...
import org.nknsd.teamcode.programs.tests.AbsoluteMovementTestProgram;

import java.util.concurrent.TimeUnit;

@TeleOp(name = "Advanced Movement Test", group="Tests")
public class NKNOpMode_AdvancedMovementTest extends OpMode {
    ...
    private final NKNProgram program = new AbsoluteMovementTestProgram();
