...
import org.nknsd.teamcode.programs.tests.SpecimenTestProgram;

import java.util.concurrent.TimeUnit;

@TeleOp(name = "Specimen Test", group="Tests")
public class NKNOpMode_SpecimenTest extends OpMode {
    ...
    private final NKNProgram program = new SpecimenTestProgram();
