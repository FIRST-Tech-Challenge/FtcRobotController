 ...
 */
public class HardwarePixelbotA
{
...
//  public double         thinnearMotorAmps = 0.0;     // current power draw (Amps)
    ...
    public double  COLLECTOR_EJECT_POWER = 0.90;  // Speed of the collector motor for autonomous (assumes INSIDE!)
    ...
    public double COLLECTOR_SERVO_GROUND = 0.870; // flipped (0.830 spacer; 0.910 no spacer flipped)
    ...
    /* Constructor */
    public HardwarePixelbotA(Telemetry telem){
        telemetry = telem;
    }
...
//      thinnearMotorAmps   = thinnearMotor.getCurrent(MILLIAMPS);
    ...
    public int fastSonarRange( UltrasonicsInstances sensorInstance, UltrasonicsModes mode ) {
        ...
        if( mode == HardwarePixelbotA.UltrasonicsModes.SONIC_FIRST_PING ) {
            cm = 0;
        }
        // Return
        return cm;
