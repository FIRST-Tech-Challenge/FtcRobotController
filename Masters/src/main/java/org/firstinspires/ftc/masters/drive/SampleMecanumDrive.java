...
//                return new Pose2d(72 - 29.25 - Math.abs(detection.ftcPose.range * Math.sin(theta)), 72  - 7.5  - Math.abs(detection.ftcPose.range * Math.cos(theta)), Math.toRadians(detection.ftcPose.yaw));
