...
@Config
@Autonomous(name = "Red Backdrop 2 + 0 Outtake", group = "competition")
public class RedBackDrop_2_0_Outtake extends BackDropOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        rightPurple = RedBackDropPath.getRightPurpleOuttake(drive, startPose);
        leftPurple = RedBackDropPath.getLeftPurpleOuttake(drive, startPose);
        middlePurple = RedBackDropPath.getMidPurpleOuttake(drive, startPose);
