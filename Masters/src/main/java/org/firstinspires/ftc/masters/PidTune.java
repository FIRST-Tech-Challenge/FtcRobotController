...
public class PidTune extends OpMode {
    ...
    public void init() {
        ...
        rotateSlide = hardwareMap.get(DcMotorEx.class, "rotateSlide");
        rotateSlide.setMode(DcMotor.RunMode.STOP_AND_RESET_ENCODER);
    }

    public void loop(){
        controller.setPID(p,i,d);
        int rotatePos = rotateSlide.getCurrentPosition() * -1;
