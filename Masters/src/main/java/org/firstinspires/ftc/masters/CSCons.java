...
public class CSCons {
    ...
    public static double[] claw = {0.4,0.82, 0.675}; // open, closed, transfer
    ...
    public static double[]outtakeAngle={0.234, 0.75}; //folder, transfer
    public static double[] doubleServoBack= {0.7, 0.159}; //drop, transfer
