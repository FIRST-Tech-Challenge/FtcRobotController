...
@Config
public class PropFindLeft extends OpenCvPipeline {

    public final Rect interestMid = new Rect(220, 180, 32, 50);
    public final Rect interestRight = new Rect(540, 230, 32, 50);
    ...
    public PropFindLeft(Telemetry telemetry, TelemetryPacket packet) {
