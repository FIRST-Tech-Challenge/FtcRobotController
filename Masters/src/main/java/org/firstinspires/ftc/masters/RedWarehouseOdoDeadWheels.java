...
@Autonomous(name="Red - Warehouse dead wheels", group = "competition")
public class RedWarehouseOdoDeadWheels extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
      //  robot = new RobotClass(hardwareMap,telemetry,this);
        ...
        SampleMecanumDriveDeadWheels drive = new SampleMecanumDriveDeadWheels(hardwareMap, this, telemetry);
...
//                    })
                    .splineToSplineHeading(new Pose2d(-11, -43, Math.toRadians(90)), Math.toRadians(90))
                    .build();
