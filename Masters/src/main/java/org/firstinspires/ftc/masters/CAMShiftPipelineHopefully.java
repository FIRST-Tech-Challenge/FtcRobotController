...
// Hey, future Oliver, this is just your reminder that Greg (the intern)
// arbitrarily changed everything from YCrCb to HSV without doing any of
// the necessary conversions. Good luck.
...
//    public static Scalar scalarUpperYCrCb = new Scalar(255.0, 255.0, 255.0);
    ...
    // Green                                             Y      Cr     Cb
     public static Scalar scalarLowerHSV = new Scalar(  0.0, 0.0, 0.0);
     public static Scalar scalarUpperHSV = new Scalar(255.0, 120.0, 120.0);
    ...
    public CAMShiftPipelineHopefully(double borderLeftX, double borderRightX, double borderTopY, double borderBottomY) {
        this.borderLeftX = borderLeftX;
        this.borderRightX = borderRightX;
        this.borderTopY = borderTopY;
        this.borderBottomY = borderBottomY;
    }
    public void configureScalarLower(double h, double s, double v) {
        scalarLowerHSV = new Scalar(h, s, v);
    }
    public void configureScalarUpper(double h, double s, double v) {
        scalarUpperHSV = new Scalar(h, s, v);
    }
    public void configureScalarLower(int h, int s, int v) {
        scalarLowerHSV = new Scalar(h, s, v);
    }
    public void configureScalarUpper(int h, int s, int v) {
        scalarUpperHSV = new Scalar(h, s, v);
    }
