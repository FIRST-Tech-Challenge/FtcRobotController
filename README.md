# Sharyland FTC Robot Controller Repository

This repository is a club-specific fork of the official [FTC Robot Controller](https://github.com/FIRST-Tech-Challenge/FtcRobotController) provided by FIRST. It serves as the foundational framework for all six Sharyland High School FTC Robotics teams competing in the FIRST in Texas South Division.

## Workflow

- **Initial Setup**: Teams start from the latest official FTC Robot Controller version each season.
- **Team Folders**: Each team independently develops and maintains its robot code inside its dedicated folder under `TeamCode`.
- **Shared Libraries**: Common functions, classes, and utilities developed collaboratively by teams are placed in the `shared` directory.
- **Pull Requests and Code Reviews**: Teams use pull requests for collaborative review, mentoring, and ensuring code quality.
...
Mentors help maintain consistent coding standards, assist with debugging, and support hardware/software integration.

## Contributing

We encourage all teams to contribute improvements, bug fixes, documentation updates, and helpful utilities to the shared codebase. Contributions should be made via pull requests and reviewed collaboratively by mentors and peers.

> **Happy coding, Rattlers—let's have another fantastic season!**
