## NOTICE
zip or .tar.gz archive file)" doc
* If you are a git user, yo
### Javadoc Reference Mate
## Welcome!
<p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;git clone https://gcumentation](https://github.com
## Downloading the Projectp;&nbsp;&nbsp;&nbument that is constantly being updated and edited.  It contains the most current information about the *FIRST* Tech Challenge software and control system.

Even if you are an advanced J from the Downloads subsection of the [Releases](https://github.com/FIRST-Tech-Challenge/FtcRobotController/releases) page for this repository.

* The Releases page
  If you are new to roboti
  &nbsp;&nbsp
  *r reviewing the [FTC Blocks Tutorial]sp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[Ftcalso contains prebuilt APKs.
  entation is an "evergreenava programmer, it is helpful to start with the [FTC Blocks tutorial](https://github.com/FIRST-Tech-Challenge/FtcRobotController/wiki/Blocks-Tutorial), and then migrate to the [OnBot Java Tool](https://github.com/FIRST-Tech-Challenge/FtcRobotController/wiki/OnBot-Java-Tutorial) or to [Android Studio](https://github.com/FIRST-Tech-Challenge/FtcRobotController/wiki/Android-Studio-Tutorial) afterwards.
  RobotController Online Do of the
  If you are an Android Studio programmer, there are several ways to download this repo.  Note that if you use the Blocks or OnBot Java Tool to program your robot, then you do not need to download this repository.
  sp;[FTC Blocks On You can also download the project folder (as a .tory:
  public FTC SDK for the Freight Frenzy (2021-2022) competition season.
  tion with information and tutorials on how to use the *FIRST* Tech Challenge software and robot control system.  You can access this documentation using the following link:
  cs or new to the *FIRST* Tech Challenge, then you should consideline Tutorial](https://github.com/FIRST-Tech-Challenge/FtcRobotController/wiki/Blocks-Tutorial)
  u can clone the most current versionithub.com/FIRST(https://github.com/FIRST-Tech-Challenge/FtcRobotController/wiki/Blocks-Tutorial) to get familiar with how to use the control system:
  ;&nbs reposi
  This repository contains the
This GitHub repository contains the source code that is used to build an Android app to control a *FIRST* Tech Challenge competition robot.  To use this SDK, download/clone the entire project to your local computer.

## Getting Started/FIRST-Tech-Challenge/FtcRobotController/wiki)

Note that the online docum
* Or, if you prefer, you can use the "Download Zip" button available through the main repository page.  Downloading the project as a .ZIP file will keep the size of the download manageable.

&nb-Tech-Challenge/FtcRobotController.git</p>

Once you have downloaded and uncompressed (if needed) your folder, you can use Android Studio to import the folder  ("Import project (Eclipse ADT, Gradle, etc.)").

## Getting Help
### User Documentation and Tutorials
*FIRST* maintains online documentarial
