...
public class OriginalSkyStoneDifferentiation implements RobotNonBlockingDevice {
    ...
    public OriginalSkyStoneDifferentiation(RobotPose3D CameraPosition, RobotCamera Camera){
    ...
    public OriginalSkyStoneDifferentiation(OriginalSkyStoneDifferentiation oldNav){
    ...
    protected void __setupVuforia(){
        ...
        m_TargetsSkyStone = vuforia.loadTrackablesFromAsset("Skystone_Original_StoneOnly");
