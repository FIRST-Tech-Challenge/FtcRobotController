/*
 * Retrieved from https://gist.github.com/lecho/7627739#file-splineinterpolation-java-L14
...
public class SplineInterpolator {
    ...
    public SplineInterpolator(SplineInterpolator oldInterpolator){
        this.mX = oldInterpolator.mX;
        this.mY = oldInterpolator.mY;
        this.mM = new double[oldInterpolator.mM.length];
        for(int i = 0; i < this.mM.length; i++){
            this.mM[i] = oldInterpolator.mM[i];
        }
    }
     ...
     */
    public static SplineInterpolator createMonotoneCubicSpline(List<Double> x, List<Double> y) throws IllegalArgumentException {
