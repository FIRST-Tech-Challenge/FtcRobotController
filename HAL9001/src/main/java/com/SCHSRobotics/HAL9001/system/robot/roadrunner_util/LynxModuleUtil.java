...
public class LynxModuleUtil {
     ...
     */
    public static @Nullable LynxFirmwareVersion getFirmwareVersion(@NotNull LynxModule module) {
     ...
     */
    public static void ensureMinimumFirmwareVersion(@NotNull HardwareMap hardwareMap) {
    ...
    public static class LynxFirmwareVersion implements Comparable<LynxFirmwareVersion> {
        ...
        @Override
        public int compareTo(@NotNull LynxFirmwareVersion other) {
