...
public class RedNearBackboard extends AutonomousBase{
    ...
    public void runOpMode() throws InterruptedException {
        ...
        if (initialPos == PixelPosition.Right) {
            ...
            if (aprilTagDetector.scanForAprilTagById(3) != null) { // scan for tag
            ...
            robotDriver.gyroDrive(0.1, -1, -90, 2, null);
            ...
            robotDriver.gyroTurn(0.2, -90, 3);
            robotDriver.gyroDrive(0.3, 22.5, -90, 3, null);
            for (int i = 0; i < 5; i++) { // repeatedly scan for april tags while moving left
                if (aprilTagDetector.scanForAprilTagById(1) != null) { // tag found
            ...
            for (int i = 0; i < 4; i++) { // repeatedly scan for april tags while moving left
