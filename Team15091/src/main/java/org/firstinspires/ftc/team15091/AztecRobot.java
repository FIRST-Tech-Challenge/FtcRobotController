...
public class AztecRobot {
    ...
    public AztecRobot(HardwareMap hardwareMap) {
        this(hardwareMap, true);
    }

    public AztecRobot(HardwareMap hardwareMap, boolean initIMU) {
    ...
    void setDriveMode(DcMotor.RunMode driveMode) {
        for (DcMotorEx motor : motors) {
