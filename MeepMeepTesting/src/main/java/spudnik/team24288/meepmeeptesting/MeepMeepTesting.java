        ...
        switch (SEQUENCE) {
            case "BlueBottom":
                myBot = new DefaultBotBuilder(meepMeep)
                        ...
                        .followTrajectorySequence(drive -> drive.trajectorySequenceBuilder(new Pose2d(-35.46, 68.29, Math.toRadians(-88.94)))
                            .splineTo(new Vector2d(-36.05, 24.72), Math.toRadians(269.23))
                            .splineTo(new Vector2d(24.00, 11.00), Math.toRadians(-16.96))
                            .lineToSplineHeading(new Pose2d(53.05, 36.05, Math.toRadians(178.55)))
                            .build()
                    );
                break;
            case "RedBottom":
