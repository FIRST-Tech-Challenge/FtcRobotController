...
public class RedDepot {
	public static void main(String[] args) {
		...
		RoadRunnerBotEntity bot = new DefaultBotBuilder(mm) //Creates a new Roadrunner bot
				.setColorScheme(new ColorSchemeRedDark()) //Sets the bot's color to be dark red
				...
				.followTrajectorySequence(drive ->
					drive.trajectorySequenceBuilder(new Pose2d(-34, -63, Math.toRadians(-90)))
						.addSpatialMarker(new Vector2d(-25,-39),() -> { /* mechanisms.rotateArm(Utility_Constants.THIRD_LEVEL_POS,0.65); */ })
