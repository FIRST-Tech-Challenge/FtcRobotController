...
//                                .setReversed(true).splineToSplineHeading(new Pose2d(37, 50, toRadians(70)), toRadians(250))
...
////                                .splineToSplineHeading(new Pose2d(63, 12, Math.toRadians(0)), Math.toRadians(0))
////                                .setReversed(true)
////                                .splineToSplineHeading(new Pose2d(30, 8, Math.toRadians(40)), Math.toRadians(220))
////
////                                .setReversed(false)
////                                .splineToSplineHeading(new Pose2d(45, 12, Math.toRadians(0)), Math.toRadians(0))
////                                .splineToSplineHeading(new Pose2d(63, 12, Math.toRadians(0)), Math.toRadians(0))
////                                .setReversed(true)
////                                .splineToSplineHeading(new Pose2d(30, 8, Math.toRadians(50)), Math.toRadians(230))
//
////                                //park 1
////                                .setReversed(false)
...
//                                .setReversed(true)
//                                .splineToSplineHeading(new Pose2d(10, 12, Math.toRadians(0)), Math.toRadians(180))
//
