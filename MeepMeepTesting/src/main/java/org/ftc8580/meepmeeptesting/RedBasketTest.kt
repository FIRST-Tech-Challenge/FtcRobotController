        ...
        DefaultBotBuilder(meepMeep) // Set bot constraints: maxVel, maxAccel, maxAngVel, maxAngAccel, track width
            ...
            .followTrajectorySequence { drive: DriveShim ->
                drive.trajectorySequenceBuilder(
                    ...
                    .lineToLinearHeading(Pose2d(-30.0, -26.75, Math.toRadians(180.0)))
                    .waitSeconds(2.0)
                    .lineToLinearHeading(Pose2d(-52.0, -52.0, Math.toRadians(-135.0)))
                    .waitSeconds(2.0)
                    .lineToLinearHeading(Pose2d(-42.0, -26.75, Math.toRadians(180.0)))
                    .waitSeconds(2.0)
                    .lineToLinearHeading(Pose2d(-52.0, -52.0, Math.toRadians(-135.0)))
                    .waitSeconds(2.0)
                    .lineToLinearHeading(Pose2d(-54.0, -26.75, Math.toRadians(180.0)))
                    .waitSeconds(2.0)
                    .lineToLinearHeading(Pose2d(-52.0, -52.0, Math.toRadians(-135.0)))
                    .waitSeconds(2.0)
                    .lineToLinearHeading(Pose2d(-24.0, -14.0, Math.toRadians(0.0)))
                    .build()
            }
