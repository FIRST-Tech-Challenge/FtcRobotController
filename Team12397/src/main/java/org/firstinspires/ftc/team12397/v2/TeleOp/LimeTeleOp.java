...
public class LimeTeleOp extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        while (opModeIsActive()) {
            ...
            telemetry.addData("Inches right/left", tdcReturn.getYawCorrection(AngleUnit.DEGREES));
            telemetry.addData("Inches right/left", tdcReturn.getClawYawCorrection(AngleUnit.DEGREES));
            telemetry.update();
        }
    }
