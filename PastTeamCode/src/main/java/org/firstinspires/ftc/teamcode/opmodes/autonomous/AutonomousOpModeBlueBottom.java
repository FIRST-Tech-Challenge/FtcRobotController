...
@Autonomous(name = "BLUE, BOTTOM", group = "Autonomous")
public class AutonomousOpModeBlueBottom extends BaseOpMode {
    ...
    public void init_loop() {
        super.init_loop();
        primary_scan = true; // tensorFlow.getInference().size() > 0;
