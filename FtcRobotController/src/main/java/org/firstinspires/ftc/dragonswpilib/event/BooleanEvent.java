...
package org.firstinspires.ftc.dragonswpilib.event;
...
public class BooleanEvent implements BooleanSupplier {
    ...
    public BooleanEvent(EventLoop loop, BooleanSupplier signal) {
        m_loop = loop;//requireNonNullParam(loop, "loop", "BooleanEvent");
        m_signal = signal;//requireNonNullParam(signal, "signal", "BooleanEvent");
    }
