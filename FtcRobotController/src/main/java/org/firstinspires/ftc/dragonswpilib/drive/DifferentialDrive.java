...
package org.firstinspires.ftc.dragonswpilib.drive;
...
public class DifferentialDrive extends RobotDriveBase /*implements Sendable, AutoCloseable*/ {
  ...
  public void arcadeDrive(double xSpeed, double zRotation, boolean squareInputs) {
    ...
    WheelSpeeds speeds = arcadeDriveIK(xSpeed, zRotation, squareInputs);

    m_leftMotor.setPower(speeds.left * m_maxOutput);
    m_rightMotor.setPower(speeds.right * m_maxOutput);
  ...
  public void tankDrive(double leftSpeed, double rightSpeed, boolean squareInputs) {
    ...
    WheelSpeeds speeds = tankDriveIK(leftSpeed, rightSpeed, squareInputs);
