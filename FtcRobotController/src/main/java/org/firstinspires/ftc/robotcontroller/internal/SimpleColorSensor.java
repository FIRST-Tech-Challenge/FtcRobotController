...
public class SimpleColorSensor extends LinearOpMode {
    ...
    protected void runSample() {
        ...
        // xButtonCurrentlyPressed keeps track of the current state of the X button on the gamepad
        ...
        while (opModeIsActive()) {
            ...
            telemetry.addLine("Press the X button on gamepad 1 to read the color again.\n");
