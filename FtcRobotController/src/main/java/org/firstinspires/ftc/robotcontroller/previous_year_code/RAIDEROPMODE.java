...
public class RAIDEROPMODE extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        while (opModeIsActive()) {
            ...
            double axial   = -0.85 * gamepad1.left_stick_y;  // Note: pushing stick forward gives negative value
            double lateral =  0.85 * gamepad1.left_stick_x;
            double yaw     =  -0.85 * gamepad1.right_stick_x;
