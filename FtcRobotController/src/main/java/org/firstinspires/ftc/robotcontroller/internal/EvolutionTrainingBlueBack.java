...
@TeleOp(name="Evolution Training Blue Back", group="Evolution")
//@Disabled
public class EvolutionTrainingBlueBack extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        while (opModeIsActive()) {
            ...
            out = append(out, new double[]{gamepad1.left_stick_x, gamepad1.right_stick_x, gamepad1.left_stick_y, clawOpen, lift.getPower(), ziptie.getPower(), pixel.getPosition()});
    ...
    double[][] append(double[][] array, double[] num){
        double[][] cell = new double[array.length + 1][array[0].length];
