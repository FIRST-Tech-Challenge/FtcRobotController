...
👀 This is the juicy bit, these are the backbone of the Scheduler API. Or wait, are they more like limbs? Anyways, they run *before* `beforeEach` and *after* `afterEach` (🤯)
...
:::tip
Because the above 4 methods return the Listener instance, it can actually [chain](https://stackoverflow.com/questions/2872222/how-to-do-method-chaining-in-java-o-m1-m2-m3-m4) these methods together, so you can
