...
👀 This is the juicy bit, they're what makes your code so clean. They run *before* `beforeEach` and *after* `afterEach` (🤯)
...
:::tip
Because the above 4 methods return the Listener instance, it can actually chain these methods together, so you can
