...
The Blacksmith Library provides a few different things:
 ...
 - [BlackOp](/blackop/overview) - An extension to the traditional OpMode/LinearOpMode which contains some extra features for a more seamless and carefree development experience
